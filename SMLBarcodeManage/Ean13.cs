...
namespace SMLBarcodeManage
{
    public class Ean13
    {
        ...
        Dictionary<int, Parity> parity = new Dictionary<int, Parity>();
        ...
        void AddCode(int digit, string lhOdd, string lhEven, string rh)
        {
        ...
        void AddParity(int digit, string par)
        {
        ...
        public void _createEan13(string code, string title)
        {
            this._createEan13(code, title, new Ean13Settings());
        }

        public void _createEan13(string code, string title, Ean13Settings settings)
        {
