...
{
    public class _createCode39 
    {
        public Image _createBarCode(string barcode)
        {
            Code39 __barcode = new Code39(barcode);
             return (Image) __barcode.Paint();
        }

        public Image _createBarCode(string barcode, Code39Settings settings)
        {
            Code39 __barcode = new Code39(barcode, settings);
            return (Image)__barcode.Paint();
        }
    }
