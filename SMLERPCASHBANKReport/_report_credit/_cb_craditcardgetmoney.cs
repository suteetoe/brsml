...
{
    public partial class _cb_craditcardgetmoney : UserControl
    {
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5},{6},{7},{8}"
                        + " from {0} where trans_type=3 and trans_flag=33 and  {9} {10} {11} {12}",
                        ...
                        _g.d.cb_trans_detail._bank_code,         //{5}
                         "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=3 and trans_flag=33 ) as sum_amount",  //{6}
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._cb_craditcardgetmoney.ToString());
        ...
        {
            //////////////////this._myCondition.TitleName = ":: รายงานขึ้นเงินบัตรเครดิต ::";
            //////////////////this._myCondition.PageName = "_cb_creditcardgetmoney";
            //////////////////this._myCondition.ShowDialog();
            //////////////////_openpop = true;
            //////////////////_ds = null;
            this._showCondition();
        ...
        ////////////////////////            + "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=3 and trans_flag=33 )"
        ////////////////////////            + " as sum_amount,remark,bank_branch "
        ////////////////////////            + " from cb_trans_detail where trans_type=3 and trans_flag=33 " + _getConditonResult;
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                _view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "รายงานขึ้นเงินบัตรเครดิต", SMLReport._report._cellAlign.Center, _view1._fontHeader2);
