...
{
    public partial class _cb_craditcardgetmoneycancel : UserControl
    {
        ...
        private string[] _cb_detail_column = {_g.d.cb_trans_detail._table+"."+_g.d.cb_trans_detail._doc_no,
                                             ...
                                             _g.d.cb_trans_detail._table+"."+_g.d.cb_trans_detail._credit_card_no};

        public _cb_craditcardgetmoneycancel()
        {
            InitializeComponent();
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5},{6},{7},{8}"
                        + " from {0} where trans_type=3 and trans_flag=34 and  {9} {10} {11} {12}",
                        _g.d.cb_trans_detail._table,          //{0}
                        _g.d.cb_trans_detail._doc_date,       //{1}
                        _g.d.cb_trans_detail._doc_no,         //{2}
                        "(select ar_code from cb_credit_card where cb_credit_card.credit_card_no = cb_trans_detail.credit_card_no) as ar_name",//{3}
                        _g.d.cb_trans_detail._credit_card_no,//{4}
                        _g.d.cb_trans_detail._bank_code,         //{5}
                         "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=3 and trans_flag=34 ) as sum_amount",  //{6}
                          _g.d.cb_trans_detail._remark,//{7}
                           _g.d.cb_trans_detail._bank_branch,//{8}
                        __where,                            //{9}
                        __getUserWhere1,                    //{10}
                        __getUserWhere2,                    //{11}
                        __orderBy);                         //{12}
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._cb_craditcardgetmoneycancel.ToString());
        ...
        {
            ////////////////////this._myCondition.TitleName = ":: รายงานยกเลิกขึ้นเงินบัตรเครดิต ::";
            ////////////////////this._myCondition.PageName = "_cb_creditcardgetmoneycancle";
            ////////////////////this._myCondition.ShowDialog();
            ////////////////////_openpop = true;
            ////////////////////_ds = null;
            this._showCondition();
        ...
        //////////////////////        string _query = "select doc_date,doc_no,"
        //////////////////////            + "(select ar_code from cb_credit_card where cb_credit_card.credit_card_no = cb_trans_detail.credit_card_no) as ar_name,"
        //////////////////////            + "credit_card_no,bank_code,"
        //////////////////////            + "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=3 and trans_flag=34 )"
        //////////////////////            + " as sum_amount,remark,bank_branch "
        //////////////////////            + " from cb_trans_detail where trans_type=3 and trans_flag=34 " + _getConditonResult;
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                _view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "รายงานยกเลิกขึ้นเงินบัตรเครดิต", SMLReport._report._cellAlign.Center, _view1._fontHeader2);
                ...
                if (type == SMLReport._report._objectType.Detail)
                {
                    ...
                    _view1._addColumn(__ojtReport, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "วันที่เอกสาร", "", SMLReport._report._cellAlign.Default);
