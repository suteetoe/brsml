...
namespace SMLERPCASHBANKReport._report_credit
{
    public partial class _cb_creditcardcancel : UserControl
    {
        ...
        private string[] _cb_detail_column = {_g.d.cb_credit_card._table+"."+_g.d.cb_credit_card._credit_card_no,
                                             _g.d.cb_credit_card._table+"."+_g.d.cb_credit_card._credit_due_date,
                                             _g.d.cb_credit_card._table+"."+_g.d.cb_credit_card._ar_code};


        public _cb_creditcardcancel()
        {
            InitializeComponent();
        ...
        void _view1__loadDataByThread()
        {
            if (this._ds == null)
            {
                try
                {
                    ...
                    //sub query
                    string __query = string.Format("select {1},{2},{3},{4},{5},{6},{7},{8}"
                        + " from {0} where status = 0 and {9} {10} {11} {12}",
                        _g.d.cb_credit_card._table,             //{0}
                        _g.d.cb_credit_card._credit_due_date,   //{1}
                        _g.d.cb_credit_card._credit_get_date,   //{2}
                        _g.d.cb_credit_card._ar_code,           //{3}
                        _g.d.cb_credit_card._credit_card_no,    //{4}
                        _g.d.cb_credit_card._bank_code,         //{5} 
                        _g.d.cb_credit_card._amount,            //{6}
                        _g.d.cb_credit_card._remark,            //{7}
                        _g.d.cb_credit_card._bank_branch,       //{8} 
                        __where,                                //{9}
                        __getUserWhere1,                        //{10}
                        __getUserWhere2,                        //{11}
                        __orderBy);                             //{12}
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._cb_creditcardcancel.ToString());
        ...
        {
            //////////////////this._myCondition.TitleName = ":: รายงานยกเลิกรายการบัตรเครดิต ::";
            //////////////////this._myCondition.PageName = "_cb_creditcardcancle";
            //////////////////this._myCondition.ShowDialog();
            //////////////////_openpop = true;
            //////////////////_ds = null;
            this._showCondition();
        ...
        void _view1__getDataObject()
        {
            try
            {
                ...
                for (int _row = 0; _row < _dr.Length; _row++)
                {
                    ...
                    _view1._addDataColumn(__ojtReport, __dataObject, 4, _dr[_row].ItemArray[4].ToString() + "/" + _dr[_row].ItemArray[7].ToString(), null, SMLReport._report._cellAlign.Center, 0,SMLReport._report._cellType.String);
                    ...
                    _view1._addDataColumn(__ojtReport, __dataObject, 6, _dr[_row].ItemArray[6].ToString(), null, SMLReport._report._cellAlign.Center, 0,SMLReport._report._cellType.String);
        ...
        //////////////////////////////        string _query = "select credit_due_date,credit_get_date,ar_code,credit_card_no,bank_code,amount,remark,bank_branch"
        //////////////////////////////            + " from cb_credit_card where status = 0 " + _getConditonResult;
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                _view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "รายงานรับเงินสดย่อย", SMLReport._report._cellAlign.Center, _view1._fontHeader2);
                ...
                if (type == SMLReport._report._objectType.Detail)
                {
                    ...
                    _view1._addColumn(__ojtReport, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "วันที่ครบกำหนด", "", SMLReport._report._cellAlign.Default);
                    _view1._addColumn(__ojtReport, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "วันที่รับบัตรเครดิต", "", SMLReport._report._cellAlign.Default);
                    _view1._addColumn(__ojtReport, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ชื่อลูกค้า", "", SMLReport._report._cellAlign.Default);
                    _view1._addColumn(__ojtReport, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "เลขที่บัตรเคดิต", "", SMLReport._report._cellAlign.Default);
                    _view1._addColumn(__ojtReport, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ธนาคาร/สาขา", "", SMLReport._report._cellAlign.Default);
                    ...
                    _view1._addColumn(__ojtReport, 30, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "หมายเหตุ/คำอธิบาย", "", SMLReport._report._cellAlign.Default);
                    __ojtReportDetail = _view1._addObject(_view1._objectList, SMLReport._report._objectType.Detail, true, 0, true, SMLReport._report._columnBorder.Bottom);
