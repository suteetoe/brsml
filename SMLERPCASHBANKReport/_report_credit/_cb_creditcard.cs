...
{
    public partial class _cb_creditcard : UserControl
    {
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5},{6},{7},{8}"
                        + " from {0} where status = 1 and {9} {10} {11} {12}",
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._cb_creditcard.ToString());
        ...
        {
            //////////////////////////this._myCondition.TitleName = ":: รายงานรายการบัตรเครดิต ::";
            //////////////////////////this._myCondition.PageName = "_cb_creditcard";
            //////////////////////////this._myCondition.ShowDialog();
            //////////////////////////_openpop = true;
            //////////////////////////_ds = null;
            this._showCondition();
        ...
        //////////////////////            + " from cb_credit_card where status = 1 " + _getConditonResult;
