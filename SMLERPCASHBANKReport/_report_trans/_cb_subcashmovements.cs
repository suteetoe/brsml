...
{
    public partial class _cb_subcashmovements : UserControl
    {
        ...
        private string[] _cb_detail_column = {_g.d.cb_trans_detail._table+"."+_g.d.cb_trans_detail._doc_no,
                                             ...
                                             _g.d.cb_trans_detail._table+"."+_g.d.cb_trans_detail._petty_cash_code};

        public _cb_subcashmovements()
        {
            InitializeComponent();
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5}"
                        + " from {0} where trans_type=4 and  {6} {7} {8} {9}",
                        _g.d.cb_trans_detail._table,          //{0}
                        _g.d.cb_trans_detail._doc_date,       //{1}
                        _g.d.cb_trans_detail._doc_no,         //{2}
                        _g.d.cb_trans_detail._petty_cash_code,//{3}
                        _g.d.cb_trans_detail._remark,         //{4}
                         "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=4) as sum_amount",  //{5}                        
                        __where,                            //{6}
                        __getUserWhere1,                    //{7}
                        __getUserWhere2,                    //{8}
                        __orderBy);                         //{9}
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._cb_subcashmovements.ToString());
        ...
        {
            ////////////////////this._myCondition.TitleName = ":: รายงานเคลื่อนไหวเงินสดย่อย ::";
            ////////////////////this._myCondition.PageName = "_cb_subcashmovements";
            ////////////////////this._myCondition.ShowDialog();
            ////////////////////_openpop = true;
            ////////////////////_ds = null;
            this._showCondition();
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                _view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "รายงานเคลื่อนไหวเงินสดย่อย", SMLReport._report._cellAlign.Center, _view1._fontHeader2);
                ...
                if (type == SMLReport._report._objectType.Detail)
                {
                    ...
                    _view1._addColumn(__ojtReport, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "หมายเหตุคำอธิบาย", "", SMLReport._report._cellAlign.Default);
                    _view1._addColumn(__ojtReport, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ยอดรับ", "", SMLReport._report._cellAlign.Default);
                    _view1._addColumn(__ojtReport, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ยอดจ่าย", "", SMLReport._report._cellAlign.Default);
                    _view1._addColumn(__ojtReport, 30, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ยอดคงเหลือ", "", SMLReport._report._cellAlign.Default);
