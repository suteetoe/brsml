...
{
    public partial class _chq_payment : UserControl
    {
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5}"
                        + " from {0} where chq_type = 2 and  {6} {7} {8} {9}",
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._chq_payment.ToString());
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            ...
            {                
                ...
                _view1._addColumn(__ojtReport, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", _g.d.resource_report_bank._table + "." + _g.d.resource_report_bank._date_chq_payment, "", SMLReport._report._cellAlign.Default);
