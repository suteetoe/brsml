...
{
    public partial class _credit_receive : UserControl
    {
        ...
        private string[] _cb_detail_column = {_g.d.cb_credit_card._table+"."+_g.d.cb_credit_card._credit_card_no,
                                             _g.d.cb_credit_card._table+"."+_g.d.cb_credit_card._doc_ref,
                                             _g.d.cb_credit_card._table+"."+_g.d.cb_credit_card._credit_get_date};
        public _credit_receive()
        {
            InitializeComponent();            
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    if (this._conditionFromTo != null && this._conditionFromTo.Rows.Count > 0)
                    {
                        ...
                        //        _g.d.cb_credit_card._credit_card_no, this._conditionFromTo.Rows[__row][0].ToString(),
                    ...
                    {
                        string __fromCreditNumber = this._myCondition._condition_screen1._getDataStr(_g.d.resource_report._from_credit_number);
                        string __toCreditNumber = this._myCondition._condition_screen1._getDataStr(_g.d.resource_report._to_credit_number);
                        if (__fromCreditNumber.Length != 0 && __toCreditNumber.Length != 0)
                        {
                            __where.Append(string.Format("({0} between \'{1}\' and \'{2}\')", _g.d.cb_credit_card._credit_card_no, __fromCreditNumber, __toCreditNumber));
                        }
                        else if (__fromCreditNumber.Length != 0 && __toCreditNumber.Length == 0)
                        {
                            __where.Append(string.Format("({0} = \'{1}\')", _g.d.cb_credit_card._credit_card_no, __fromCreditNumber));
                        }
                        else if (__fromCreditNumber.Length == 0 && __toCreditNumber.Length != 0)
                        {
                            __where.Append(string.Format("({0} = \'{1}\')", _g.d.cb_credit_card._credit_card_no, __toCreditNumber));
                        }
                        else
                        {
                            __where.Append(string.Format("({0} between \'{1}\' and \'{2}\')", _g.d.cb_credit_card._credit_card_no, "0", "z"));
                        }
                    }
                    //=======================================================================================================
                    //order by
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5}"
                        + " from {0} where trans_type = 1 and  {6} {7} {8} {9}",
                        _g.d.cb_credit_card._table,          //{0}
                        _g.d.cb_credit_card._date_cut,       //{1}
                        _g.d.cb_credit_card._doc_ref,         //{2}
                        _g.d.cb_credit_card._credit_card_no,//{3}
                        _g.d.cb_credit_card._remark,         //{4}
                        _g.d.cb_credit_card._sum_amount,  //{5}                        
                        __where,                            //{6}
                        __getUserWhere1,                    //{7}
                        __getUserWhere2,                    //{8}
                        __orderBy);                         //{9}
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._credit_receive.ToString());
                this._myCondition._whereControl._tableName = _g.d.cb_credit_card._table;
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                this._view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, ((MyLib._myResourceType)MyLib._myResource._findResource(_g.d.resource_report_bank._table + "." + _g.d.resource_report_bank._title_credit_receive, _g.d.resource_report_bank._table + "." + _g.d.resource_report_bank._title_credit_receive))._str, SMLReport._report._cellAlign.Left, this._view1._fontHeader2);
                ...
                if (type == SMLReport._report._objectType.Detail)
                {
                    ...
                    _view1._addColumn(__ojtReport, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", _g.d.resource_report_bank._table + "." + _g.d.resource_report_bank._date_credit_receive, "", SMLReport._report._cellAlign.Default);
                    ...
                    _view1._addColumn(__ojtReport, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", _g.d.resource_report_bank._table + "." + _g.d.resource_report_bank._credit_card_no, "", SMLReport._report._cellAlign.Default);
        ...
        void _view1__getDataObject()
        {
            try
            {
                ...
                for (int _row = 0; _row < _dr.Length; _row++)
                {
                    ...
                    _view1._addDataColumn(__ojtReport, __dataObject, 0, MyLib._myGlobal._convertDateFromQuery(_dr[_row].ItemArray[0].ToString()).ToShortDateString(), null, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                    _view1._addDataColumn(__ojtReport, __dataObject, 0, MyLib._myGlobal._convertDateFromQuery(_dr[_row][_g.d.cb_credit_card._date_cut].ToString()).ToShortDateString(), null, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                    _view1._addDataColumn(__ojtReport, __dataObject, 1, _dr[_row][_g.d.cb_credit_card._doc_ref].ToString(), null, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                    _view1._addDataColumn(__ojtReport, __dataObject, 2, _dr[_row][_g.d.cb_credit_card._credit_card_no].ToString(), null, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                    _view1._addDataColumn(__ojtReport, __dataObject, 3, _dr[_row][_g.d.cb_credit_card._remark].ToString(), null, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                    decimal __amount = MyLib._myGlobal._decimalPhase(_dr[_row][_g.d.cb_credit_card._sum_amount].ToString().Equals("") ? "0" : _dr[_row][_g.d.cb_credit_card._sum_amount].ToString());
