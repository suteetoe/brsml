...
{
    public partial class _credit_payment : UserControl
    {
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5}"
                        + " from {0} where trans_type = 2 and  {6} {7} {8} {9}",
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._credit_payment.ToString());
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                this._view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, ((MyLib._myResourceType)MyLib._myResource._findResource(_g.d.resource_report_bank._table + "." + _g.d.resource_report_bank._title_credit_payment, _g.d.resource_report_bank._table + "." + _g.d.resource_report_bank._title_credit_payment))._str, SMLReport._report._cellAlign.Left, this._view1._fontHeader2);
                ...
                if (type == SMLReport._report._objectType.Detail)
                {
                    ...
                    _view1._addColumn(__ojtReport, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", _g.d.resource_report_bank._table + "." + _g.d.resource_report_bank._date_credit_payment, "", SMLReport._report._cellAlign.Default);
