...
{
    public partial class _cb_subcashwithdrawcancel : UserControl
    {
        ...
        public _cb_subcashwithdrawcancel()
        {
            InitializeComponent();
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5}"
                        + " from {0} where trans_type=4 and trans_flag=38 and  {6} {7} {8} {9}",
                        ...
                        _g.d.cb_trans_detail._remark,         //{4}
                         "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=4 and trans_flag=38 ) as sum_amount",  //{5}                        
                        __where,                            //{6}
                        __getUserWhere1,                    //{7}
                        __getUserWhere2,                    //{8}
                        __orderBy);                         //{9}
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._cb_subcashwithdrawcancel.ToString());
        ...
        {
            ////////////////this._myCondition.TitleName = ":: รายงานยกเลิกขอเบิกเงินสดย่อย ::";
            ////////////////this._myCondition.PageName = "_cb_subcashwithdrawcancle";
            ////////////////this._myCondition.ShowDialog();
            ////////////////_openpop = true;
            ////////////////_ds = null;
            this._showCondition();
        ...
        ////////////////////        ////string __query = "select doc_date,doc_no,petty_cash_code,remark,"
        ////////////////////        ////                            + "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=4 and trans_flag=38 )"
        ////////////////////        ////                            + " as sum_received"
        ////////////////////        ////                            + " from cb_trans_detail " + _getConditonResult;
        ////////////////////        ////string _query = "select doc_date ,doc_no ,petty_cash_code,remark,sum_received from (" + __query + ") as temp1";
        ////////////////////        string _query = "select doc_date,doc_no,petty_cash_code,remark,"
        ////////////////////            + "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=4 and trans_flag=38 )"
        ////////////////////            + " as sum_amount"
        ////////////////////            + " from cb_trans_detail where trans_type=4 and trans_flag=38 " + _getConditonResult;
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                _view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "รายงานยกเลิกขอเบิกเงินสดย่อย", SMLReport._report._cellAlign.Center, _view1._fontHeader2);
                ...
                if (type == SMLReport._report._objectType.Detail)
                {
                    ...
                    _view1._addColumn(__ojtReport, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "รหัสเงินสดย่อย", "", SMLReport._report._cellAlign.Default);
