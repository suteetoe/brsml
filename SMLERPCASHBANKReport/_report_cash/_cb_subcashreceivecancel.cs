...
{
    public partial class _cb_subcashreceivecancel : UserControl
    {
        ...
        public _cb_subcashreceivecancel()
        {
            InitializeComponent();
            ...
            if (this._ds == null)
            {
                try
                {
                    ...
                    string __query = string.Format("select {1},{2},{3},{4},{5}"
                        + " from {0} where trans_type=4 and trans_flag=35 and  {6} {7} {8} {9}",
                        ...
                        _g.d.cb_trans_detail._remark,         //{4}
                         "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=4 and trans_flag=36 ) as sum_amount",  //{5}                        
                        __where,                            //{6}
                        __getUserWhere1,                    //{7}
                        __getUserWhere2,                    //{8}
                        __orderBy);                         //{9}
        ...
        private void _showCondition()
        {
            ...
            {
                this._myCondition = new _condition_form(_enum_screen_report_cb._cb_subcashreceivecancel.ToString());
        ...
        {
            ////////////////////this._myCondition.TitleName = ":: รายงานยกเลิกรับเงินสดย่อย ::";
            ////////////////////this._myCondition.PageName = "_cb_subcashreceivecancle";
            ////////////////////this._myCondition.ShowDialog();
            ////////////////////_openpop = true;
            ////////////////////_ds = null;
        ...
        //////////////////        ////                            + "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=4 and trans_flag=36 )"
        //////////////////        ////                            + " as sum_received"
        ...
        //////////////////            + "(select coalesce(sum(sum_amount),0) from cb_trans_detail where trans_type=4 and trans_flag=36 )"
        //////////////////            + " as sum_amount"
        //////////////////            + " from cb_trans_detail where trans_type=4 and trans_flag=36 " + _getConditonResult;
