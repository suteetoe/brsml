...
namespace MyLib
{
    ...
    [ToolboxBitmap(typeof(_grouper), "Grouper.bmp")]
    [Designer("System.Windows.Forms.Design.ParentControlDesigner, System.Design", typeof(IDesigner))]
    public class _grouper : System.Windows.Forms.UserControl
    {
        ...
        public _grouper()
        {
            InitializeStyles();
            InitializeGroupBox();
            this.LocationChanged += new EventHandler(_grouper_LocationChanged);
            this.SizeChanged += new EventHandler(_grouper_SizeChanged);
        }

        void _grouper_SizeChanged(object sender, EventArgs e)
        {
        ...
        void _grouper_LocationChanged(object sender, EventArgs e)
        {
            this.LocationChanged -= new EventHandler(_grouper_LocationChanged);
        ...
        private void PaintBack(System.Drawing.Graphics g)
        {
            ...
            int ArcY1 = (this.GroupTitle == string.Empty) ? 0 : 10;
