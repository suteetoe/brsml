...
namespace MyLib
{
    ...
    /// </summary>
    public class _myTreeViewDragDrop : System.Windows.Forms.TreeView
    {
        ...
        public int DragImageIndex
        {
            ...
            set
            {
                ...
                if (this._formDrag.imageList1.Images.Count > 0 && this._formDrag.imageList1.Images[value] != null)
                {
                    ...
                    this._formDrag.Size = new Size(this._formDrag.Width, this._formDrag.pictureBox1.Image.Height+4);
                    this._formDrag.labelText.Size = new Size(this._formDrag.labelText.Width, this._formDrag.pictureBox1.Image.Height+4);
                }
        ...
        public Font DragNodeFont
        {
            ...
            set
            {
                ...
                this._formDrag.Size = new Size(this._formDrag.Width, (int)this._formDrag.labelText.Font.GetHeight()+4);
                this._formDrag.labelText.Size = new Size(this._formDrag.labelText.Width, (int)this._formDrag.labelText.Font.GetHeight()+4);
            }
        }
