...
namespace MyLib
{
	...
	public class _listViewXP : System.Windows.Forms.ListView
	{
...
/*			styles = (LVS_EX)SendMessage(this.Handle, (int)LVM.LVM_GETEXTENDEDLISTVIEWSTYLE, 0, 0);
			...
			styles = (LVS_EX)SendMessage(this.Handle, (int)LVM.LVM_GETEXTENDEDLISTVIEWSTYLE, 0, 0);
			styles |= LVS_EX.LVS_EX_DOUBLEBUFFER ;
			SendMessage(this.Handle, (int)LVM.LVM_SETEXTENDEDLISTVIEWSTYLE, 0, (int)styles);
		}
		...
		public void _setExStyles(LVS_EX exStyle)
		{
			styles = (LVS_EX)SendMessage(this.Handle, (int)LVM.LVM_GETEXTENDEDLISTVIEWSTYLE, 0, 0);
			styles |= exStyle;
			SendMessage(this.Handle, (int)LVM.LVM_SETEXTENDEDLISTVIEWSTYLE, 0, (int)styles);
