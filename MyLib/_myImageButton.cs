...
namespace MyLib
{
    ...
    /// </summary>
    [DefaultEvent("Click")]
    public class _myImageButton : System.Windows.Forms.UserControl
    {
            ...
            if (_myGlobal._language != this._lastLanguage)
            {
                ...
                if (this._name.Length > 0)
                {
                    ...
                    if (__getResourceStr.Length > 0)
                        this.ButtonText = __getResourceStr;
                }
            }
            base.OnPaint(e);
        }
        ...
        private void DrawBackground(Graphics g)
        {
            ...
            int alpha = (mButtonState == State.Pressed) ? 0 : 0;
            Rectangle r = this.ClientRectangle;
            r.Width--; r.Height--;
            using (GraphicsPath rr = RoundRect(r, CornerRadius, CornerRadius, CornerRadius, CornerRadius))
            {
        ...
        private void DrawText(Graphics g)
        {
            ...
            Rectangle r = new Rectangle(8, 8 + this.ImageSize.Height, this.Width - 17, this.Height - 17 - this.ImageSize.Height);
