...
namespace SMLERPControl
{
	...
	public class WebCamCapture : System.Windows.Forms.UserControl
	{
        ...
        private SMLERPControl.WebcamEventArgs x = new SMLERPControl.WebcamEventArgs();
		...
		*/
		...
		public void Start(ulong FrameNum)
		{
			try
			{
				...
				int __connect = SendMessage(mCapHwnd, WM_CAP_CONNECT, 0, 0);
                // 1 = connect ได้
        ...
        public bool _checkDeviceWebCam()
        {
            bool __result = true;
