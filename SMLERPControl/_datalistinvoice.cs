...
{
    public partial class _datalistinvoice : UserControl
    {
        ...
        public void _loaData()
        {
            ...
            DataSet __getData = __frameWork._invoiceGetquery(MyLib._myGlobal._databaseName, this._extraWhere);
            DataTable __dt = __getData.Tables[0];

            _dataList._loadFromDataTable(setnewDatarow(__dt));
        ...
        public void _loadViewData()
        {
            ...
            if (first)
            {
                ...
                dataResult.detail = myFrameWork._invoiceGetquerySearch(MyLib._myGlobal._databaseName, query.ToString());
                _dataList._loadFromDataTable(setnewDatarow(dataResult.detail.Tables[0]));
