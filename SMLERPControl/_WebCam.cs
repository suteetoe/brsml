...
/// <summary> Summary description for MainForm. </summary>
   // public class _WebCam : System.Windows.Forms.Form, ISampleGrabberCB
    public class _WebCam : MyLib._myForm, ISampleGrabberCB
    {
        ...
        public delegate void WebCamEventHandler(object source, SMLERPControl.WebcamEventArgs e);
        // fired when a new image is captured
        public event WebCamEventHandler ImageCaptured;
        private SMLERPControl.WebcamEventArgs _e = new SMLERPControl.WebcamEventArgs();
        public _WebCam()
        {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(_WebCam));
            ...
            this.imgListToolBar.Images.SetKeyName(0, "PrefsCamera.png");
            this.imgListToolBar.Images.SetKeyName(1, "FolderCam.png");
            // 
            // stillPanel
            // 
            ...
            // toolBarBtnGrab
            // 
            this.toolBarBtnGrab.ImageIndex = 0;
            ...
            this.toolBarBtnSave.ImageIndex = 1;
            ...
            this.Name = "_WebCam";
            this.ResourceName = "จากกล้องของเครื่อง";
        ...
        private void MainForm_Activated(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, "DirectX 8.1 NOT installed!", "Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                this.Close(); return;
            }

            if (!DsDev.GetDevicesOfCat(FilterCategory.VideoInputDevice, out capDevices))
            {
                MessageBox.Show(this, "No video capture devices found!", "Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                this.Close(); return;
            }
        ...
        string _filetemp = "camtempxx.bmp";
        ...
        private void toolBar_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
        {
            ...
            else if (e.Button == toolBarBtnSave)
            {
                ...
                string xFileName = Path.GetTempPath() + "\\" + _filetemp;
                pictureBox.Image.Save(xFileName, ImageFormat.Bmp);		// save to new bmp file

                if (ImageCaptured != null)
                {
                    _e.WebCamImage = this.pictureBox.Image;
                    // raise the event
                    this.ImageCaptured(this, _e);
                }
        ...
        void OnCaptureDone()
        {
            ...
            {
                MessageBox.Show(this, "Could not grab picture\r\n" + ee.Message, "Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
        }
