...
namespace SMLERPIC
{
    public partial class _icMainProductSet : UserControl
    {
        private string _oldCode = "";
        private MyLib._myGrid __gridTemp;

        public _icMainProductSet()
        {
            InitializeComponent();
            ...
            this._myManageDetail._dataList._extraWhere = _g.d.ic_inventory._item_type + "=3"; // 3=สินค้าชุด
            ...
            this.__gridTemp._addColumn(_g.d.ic_inventory_set_detail._price_ratio, 3, 1, 10, true, false, true, false);
        }
        ...
        bool _myManageDetail__loadDataToScreen(object rowData, string whereString, bool forEdit)
        {
            ...
            try
            {
                ...
                for (int __row = 0; __row < this.__gridTemp._rowData.Count; __row++)
                {
                    ...
                    this._icMainSetGrid._cellUpdate(__addr, _g.d.ic_trans_detail._price_set_ratio, this.__gridTemp._cellGet(__row, _g.d.ic_inventory_set_detail._price_ratio), false);
            ...
            if (MyLib._myGlobal._checkChangeMaster())
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        // เก็บอัตราส่วน
                        decimal __setPrice = 0M;
                        for (int __row = 0; __row < this._icMainSetGrid._rowData.Count; __row++)
                        {
                            __setPrice += (decimal)this._icMainSetGrid._cellGet(__row, _g.d.ic_trans_detail._sum_amount);
                        ...
                        for (int __row = 0; __row < this._icMainSetGrid._rowData.Count; __row++)
                        {
                            ...
                            if (__getItemCode.Length > 0)
                            {
                                ...
                                decimal __qty = (decimal) this._icMainSetGrid._cellGet(__row, _g.d.ic_trans_detail._qty);
                                decimal __price = (decimal)this._icMainSetGrid._cellGet(__row, _g.d.ic_trans_detail._price);
                                decimal __sumPrice = (decimal)this._icMainSetGrid._cellGet(__row, _g.d.ic_trans_detail._sum_amount);
                                ...
                                this.__gridTemp._cellUpdate(__addr, _g.d.ic_inventory_set_detail._qty,__qty, true);
                                // สูตรสี
                                this.__gridTemp._cellUpdate(__addr, _g.d.ic_inventory_set_detail._price, __price, true);
                                this.__gridTemp._cellUpdate(__addr, _g.d.ic_inventory_set_detail._sum_amount, __sumPrice, true);

                                decimal __ratio = 0M;
                                try
                                {
                                    __ratio = MyLib._myGlobal._round(__price / __setPrice, 3);
                                }
                                catch
                                {
                                }
                                this.__gridTemp._cellUpdate(__addr, _g.d.ic_inventory_set_detail._price_ratio, __ratio, true);

                            }
                        }

                        // คำนวน Rate ปรับอัตราส่วน
                        decimal __calcRate = 0M;
                        for (int __row = 0; __row < this.__gridTemp._rowData.Count; __row++)
                        {
                            __calcRate += (decimal)this.__gridTemp._cellGet(__row, _g.d.ic_inventory_set_detail._qty) * (decimal)this.__gridTemp._cellGet(__row, _g.d.ic_inventory_set_detail._price_ratio);
                        }

                        decimal __diff_value = 1 - __calcRate;
                        decimal __last_item_rato = (decimal)this.__gridTemp._cellGet(this.__gridTemp._rowData.Count - 1, _g.d.ic_inventory_set_detail._price_ratio);
                        this.__gridTemp._cellUpdate(this.__gridTemp._rowData.Count - 1, _g.d.ic_inventory_set_detail._price_ratio, (__last_item_rato + __diff_value), true);
