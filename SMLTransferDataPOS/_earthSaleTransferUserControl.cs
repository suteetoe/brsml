...
{
    public partial class _earthSaleTransferUserControl : UserControl
    {
        //MyLib._myScreen _screen_top = new MyLib._myScreen();
        //MyLib._myScreen _screen_pay = new MyLib._myScreen();
        ...
        //private SMLERPAPARControl._payCreditCardGridControl _payCreditCardGridControl1 = new SMLERPAPARControl._payCreditCardGridControl();
        //private SMLERPAPARControl._payCouponGridControl _payCouponGridControl1 = new SMLERPAPARControl._payCouponGridControl();
        ...
        public _earthSaleTransferUserControl()
        {
            InitializeComponent();
        ...
        void _loadData()
        {
            ...
            string __selectTransField = MyLib._myGlobal._fieldAndComma(
               ...
               " \'SALE\'  || \'-\' || upper(branch_code) || \'-\' || to_char(doc_date, \'YYYYMMDD\') as " + _g.d.ic_trans._doc_no,
               " branch_code as " + _g.d.ic_trans._branch_code,
               " sum(" + _g.d.ic_trans._total_amount + ") as " + _g.d.ic_trans._total_amount
               );

            string __queryLoad = "select " + __selectTransField + " from " + _g.d.ic_trans._table + " where " + __docDateTransFlagWhere + ((__branchList.Length > 0) ? " and branch_code in (" + __branchList.ToString() + ") " : "") + " group by " + _g.d.ic_trans._doc_date + ",branch_code order by " + _g.d.ic_trans._doc_date + ", branch_code";
        ...
        void _loadDataProcess(string docDate, string branch_code, int row)
        {
            ...
            string __branchCodeDetailWhere = " (select branch_code from ic_trans where ic_trans.doc_no = {0}.doc_no and ic_trans.trans_flag ={0}.trans_flag) ";
            ...
            string __selectTransField = MyLib._myGlobal._fieldAndComma(
                ...
                " \'" + branch_code + "\' as  " + _g.d.ic_trans._cust_code,
            ...
            string __queryTrans = "select " + MyLib._myGlobal._fieldAndComma(
                ...
                ) + " from " + _g.d.ic_trans._table + " where " + __docDateTransFlagWhere + " and " + __transWhere + " and branch_code = \'" + branch_code + "\' ";
            ...
            string __getCNTrans = " select doc_date " +
                ...
                ", doc_no, tax_doc_date, tax_doc_no, cust_code, doc_format_code, doc_time, trans_flag, trans_type" +
                ", total_value, total_discount, total_value - total_discount as total_after_discount, total_except_vat, total_before_vat, total_after_vat, total_vat_value, total_amount, vat_rate, is_pos, inquiry_type, vat_type" +
                " from ic_trans where doc_date = \'" + docDate + "\' and branch_code = \'" + branch_code + "\' and trans_flag = 48 and last_status = 0 ";

            // ประกอบ 
            string __queryTransStr = "select " + __selectTransField + " from (" + __queryTrans + ") as temp1 " + " union all " + __queryCreditSale + " union all " + __getCNTrans;
            ...
            string __selectField = MyLib._myGlobal._fieldAndComma(
               ...
               "\'" + __docNo + "\' as " + _g.d.ic_trans_detail._doc_no,
                ...
                "\'" + branch_code.ToUpper() + "\' as  " + _g.d.ic_trans._cust_code,
                "1 as " + _g.d.ic_trans_detail._inquiry_type,
                "0 as " + _g.d.ic_trans_detail._is_pos,
                "(select code from ic_warehouse where upper(user_group) = \'" + branch_code.ToUpper() + "\' ) as " + _g.d.ic_trans_detail._wh_code,
                "(select code from ic_shelf where whcode = (select code from ic_warehouse where upper(user_group) = '" + branch_code.ToUpper() + "' ) limit 1 ) as " + _g.d.ic_trans_detail._shelf_code,
            ...
            __queryCBTransCN.Append(MyLib._myGlobal._fieldAndComma(
                ...
                ) + " from " + _g.d.cb_trans._table + " where  doc_date = \'" + docDate + "\' and trans_flag = 48 and " + string.Format(__branchCodeDetailWhere, _g.d.cb_trans._table) + "= \'" + branch_code + "\' and " + _g.d.cb_trans._trans_type + "=" + _g.g._transTypeGlobal._transType(_g.g._transControlTypeEnum.ขาย_รับคืนสินค้าจากการขายและลดหนี้).ToString());
            ...
            __getVatSaleCN.Append(" where doc_date = \'" + docDate + "\' and " + string.Format(__branchCodeDetailWhere, _g.d.gl_journal_vat_sale._table) + " = \'" + branch_code + "\' and trans_flag = 48 ");
                ...
                for (int row = 0; row < this._transGrid._rowData.Count; row++)
                {
                    ...
                    if (__checked == "1")
                    {
                        ...
                        if (this._itemGrid._rowData.Count > 0)
                        {
                            ...
                            string __masterField = _g.d.ic_trans._last_status + ",";

                            string __masterValue = "0,";
