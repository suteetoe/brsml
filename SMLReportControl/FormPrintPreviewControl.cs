...
{
    /// <summary>
    /// Specifies the zoom mode for the <see cref="FormPrintPreviewControl"/> control.
    /// </summary>
    internal enum ZoomMode
    {
        ...
        TwoPages,
        /// <summary>
        /// Use the zoom factor specified by the <see cref="FormPrintPreviewControl.Zoom"/> property.
        /// </summary>
        Custom
    }
    ...
    /// </remarks>
    internal class FormPrintPreviewControl : UserControl
    {
        //-------------------------------------------------------------
        #region ** fields
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="FormPrintPreviewControl"/> control.
        /// </summary>
        public FormPrintPreviewControl()
        {
        ...
        internal class DocumentPrinter : PrintDocument
        {
            ...
            public DocumentPrinter(FormPrintPreviewControl preview, int first, int last)
            {
