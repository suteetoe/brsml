...
{
    /// <summary>
    /// Represents a dialog containing a <see cref="FormPrintPreviewControl"/> control
    ...
    /// PDF export.
    /// </remarks>
    internal partial class FormPrintPreviewDialogControl : UserControl
    {
        //--------------------------------------------------------------------
        #region ** fields
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="FormPrintPreviewDialogControl"/>.
        /// </summary>
        public FormPrintPreviewDialogControl() : this(null)
        {
        }
        /// <summary>
        /// Initializes a new instance of a <see cref="FormPrintPreviewDialogControl"/>.
        ...
        public FormPrintPreviewDialogControl(Control parentForm)
        {
            InitializeComponent();
            if (parentForm != null)
            {
