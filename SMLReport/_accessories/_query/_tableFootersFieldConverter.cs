...
namespace SMLReport
{
    class _tableFootersFieldConverter : StringConverter
    {
        ...
        public override TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            if (propertyGrid.SelectedObject.GetType() == typeof(SMLReport._design._tableFooters))
            {
                SMLReport._design._tableFooters __column = (SMLReport._design._tableFooters)propertyGrid.SelectedObject;
