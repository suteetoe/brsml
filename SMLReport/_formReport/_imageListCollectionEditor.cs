...
{
    public class _imageListCollectionEditor : IWindowsFormsEditorService, IServiceProvider, ITypeDescriptorContext
    {
        public static void EditValue(IWin32Window owner, object component, string propertyName)
        {
            ...
            _imageListCollectionEditor ctx = new _imageListCollectionEditor(owner, component, prop);
        ...
        private _imageListCollectionEditor(IWin32Window owner, object component, PropertyDescriptor property)
        {
            this.owner = owner;
