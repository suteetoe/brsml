...
namespace SMLInventoryControl._icPurchasePrice
{
    public partial class _icPriceList : UserControl
    {
        ...
        public _icPriceList()
        {
            ...
            this._myTabControlDetail.TableName = _g.d.ic_inventory_purchase_price._table;
        ...
        void _myToolBar_EnabledChanged(object sender, EventArgs e)
        {
            ...
            this._apPrice.Enabled = this._myToolBar.Enabled;
            //
            this._normalPrice.Invalidate();
            this._apPrice.Invalidate();
        }
        ...
        bool _myManageDetail__loadDataToScreen(object rowData, string whereString, bool forEdit)
        {
            ...
            try
            {
                ...
                string __getPriceQuery = "select *,"
                    + " (select  " + _g.d.ic_unit._name_1 + " from " + _g.d.ic_unit._table + " where " + _g.d.ic_unit._table + "." + _g.d.ic_unit._code + "=" + _g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._unit_code + ") as " + _g.d.ic_inventory_purchase_price._unit_name+","
                    + " (select  " + _g.d.ar_customer._name_1 + " from " + _g.d.ar_customer._table + " where " + _g.d.ar_customer._table + "." + _g.d.ar_customer._code + "=" + _g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._supplier_code+ ") as " + _g.d.ic_inventory_purchase_price._supplier_name
                    + " from " + _g.d.ic_inventory_purchase_price._table
                    + " where " + _g.d.ic_inventory_purchase_price._ic_code + "=\'" + _oldCode + "\' and " + _g.d.ic_inventory_purchase_price._price_type;
                __myquery.Append(MyLib._myUtil._convertTextToXmlForQuery(__getPriceQuery + "=1 order by " + _g.d.ic_inventory_purchase_price._unit_code + ",roworder")); //somruk
                ...
                this._apPrice._grid._clear();
                //
                this._normalPrice._removeEvent();
                this._apPrice._removeEvent();
                //
                this._normalPrice._grid._loadFromDataTable(((DataSet)__getData[1]).Tables[0]);
                this._apPrice._grid._loadFromDataTable(((DataSet)__getData[2]).Tables[0]);
                //
                this._normalPrice._addEvent();
                this._apPrice._addEvent();
                //
                this._icmainScreenTop.Invalidate();
                __result = true;
                this._normalPrice._itemCode = this._apPrice._itemCode = this._icmainScreenTop._getDataStr(_g.d.ic_inventory._code, false);
                this._apPrice._itemCode = this._apPrice._itemCode = this._icmainScreenTop._getDataStr(_g.d.ic_inventory._code, false);
            }
            catch (Exception __e)
            {
            ...
            if (MyLib._myGlobal._checkChangeMaster())
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        string __fieldList = _g.d.ic_inventory_purchase_price._ic_code + " , " + _g.d.ic_inventory_purchase_price._price_type + ",";
                        string __dataList = this._icmainScreenTop._getDataStrQuery(_g.d.ic_inventory._code) + " , ";
                        // Delete
                        __myQuery.Append(MyLib._myUtil._convertTextToXmlForQuery("delete from " + _g.d.ic_inventory_purchase_price._table + " where " + _g.d.ic_inventory_purchase_price._ic_code + "=" + __itemCode));
