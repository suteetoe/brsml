...
{
    public partial class _trialBalance : UserControl
    {
        public _trialBalance()
        {
            InitializeComponent();
            ...
            this._listGrid._addColumnTop("ยอดยกมา", 2, 3);
            this._listGrid._addColumnTop("ยอดประจำงวด", 4, 5);
            this._listGrid._addColumnTop("ยอดยกไป", 6, 7);
            //
            ...
            this._listGrid._addColumn(_g.d.gl_list_view._prev_debit, 3, 0, 10, true, false, true, false, __formatNumber);
            this._listGrid._addColumn(_g.d.gl_list_view._prev_credit, 3, 0, 10, true, false, true, false, __formatNumber);
            this._listGrid._addColumn(_g.d.gl_list_view._debit, 3, 0, 10, true, false, true, false, __formatNumber);
            this._listGrid._addColumn(_g.d.gl_list_view._credit, 3, 0, 10, true, false, true, false, __formatNumber);
            this._listGrid._addColumn(_g.d.gl_list_view._balance_debit, 3, 0, 10, true, false, true, false, __formatNumber);
            this._listGrid._addColumn(_g.d.gl_list_view._balance_credit, 3, 0, 10, true, false, true, false, __formatNumber);
            //
            ...
            //
            this._processButton.Click += (s1, e1) =>
            {
                this._process();
            };
        ...
        SMLERPGL._display._glListDrillDown __showDrillDown;
        void _listGrid__mouseDoubleClick(object sender, MyLib.GridCellEventArgs e)
        {
            __showDrillDown = new SMLERPGL._display._glListDrillDown();
        ...
        void _process()
        {
            ...
            else
            {
                ...
                //
                ArrayList __result = __process._glViewTrialBalance(__getDateBegin, __getDateEnd, _chartOfAccountTreeView, __getAllData, __showDebitCredit, __isPass);
