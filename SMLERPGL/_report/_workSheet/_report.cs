...
namespace SMLERPGL._report._workSheet
{
    public partial class _report : UserControl
    {
        ...
        void _view1__getDataObject()
        {
            ...
            for (int __accountRow = 0; __accountRow < __totalRecords; __accountRow++)
            {
                ...
                if (__getRow._show)
                {
                    ...
                    _view1._addDataColumn(__accountObject, __accountDataObject, __prevCredit, MyLib._myUtil._moneyFormat(__getRow._prevCredit, _formatNumber), __newFont, SMLReport._report._cellAlign.Right, 0, __newBorder, SMLReport._report._cellType.Number);
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                _view1.__excelFlieName = "กระดาษทำการ สิ้นสุด ณ. วันที่ : " + MyLib._myGlobal._convertDateToString(_conditionDateEnd, false);
                ...
                _view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "กระดาษทำการ สิ้นสุด ณ. วันที่ : " + MyLib._myGlobal._convertDateToString(_conditionDateEnd, false), SMLReport._report._cellAlign.Center, _view1._fontHeader2);
                ...
                if (type == SMLReport._report._objectType.Detail)
                {
                    ...
                    _view1._addColumn(__columnHeaderObject, 20, true, SMLReport._report._columnBorder.LeftBottom, SMLReport._report._columnBorder.Left, _g.d.gl_list_view._account_code, "งบทดลอง", _g.d.gl_list_view._account_code, SMLReport._report._cellAlign.Center);
                    _view1._addColumn(__columnHeaderObject, 20, true, SMLReport._report._columnBorder.LeftBottom, SMLReport._report._columnBorder.Left, _g.d.gl_list_view._account_code, "กำไรขาดทุน", _g.d.gl_list_view._account_code, SMLReport._report._cellAlign.Center);
                    _view1._addColumn(__columnHeaderObject, 20, true, SMLReport._report._columnBorder.LeftRightBottom, SMLReport._report._columnBorder.LeftRight, _g.d.gl_list_view._account_code, "งบดุล", _g.d.gl_list_view._account_code, SMLReport._report._cellAlign.Center);
                    // Column ข้อมูล
        ...
        bool _view1__loadData()
        {
            ...
            if (__getFromProcess == null)
            {
                ...
                __getFromProcess = __process._glViewWorkSheet(_conditionDateBegin, _conditionDateEnd, _chartOfAccountTreeView, this._conditionAllAccount, this._conditionAccountBalance,0);
            }
