...
namespace SMLERPGL._report._sheetSum
{
    public partial class _report : UserControl
    {
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                _view1.__excelFlieName = "รายงานบัญชีแยกประเภทแบบสรุป จากวันที่ : " + MyLib._myGlobal._convertDateToString(_conditionDateBegin, false) + " ถึงวันที่ : " + MyLib._myGlobal._convertDateToString(_conditionDateEnd, false);
                ...
                if (type == SMLReport._report._objectType.Detail)
                {
                    ...
                    _view1._addColumn(__accountObject, 20, true, SMLReport._report._columnBorder.Left, SMLReport._report._columnBorder.Left, _g.d.gl_list_view._account_code, _g.d.gl_list_view._table + "." + _g.d.gl_list_view._account_code, _g.d.gl_list_view._account_code, SMLReport._report._cellAlign.Left);
                    _view1._addColumn(__accountObject, 50, true, SMLReport._report._columnBorder.Left, SMLReport._report._columnBorder.Left, _g.d.gl_list_view._account_name, _g.d.gl_list_view._table + "." + _g.d.gl_list_view._account_name, _g.d.gl_list_view._account_name, SMLReport._report._cellAlign.Left);
                    _view1._addColumn(__accountObject, 15, true, SMLReport._report._columnBorder.Left, SMLReport._report._columnBorder.Left, _g.d.gl_list_view._debit, _g.d.gl_list_view._table + "." + _g.d.gl_list_view._debit, _g.d.gl_list_view._debit, SMLReport._report._cellAlign.Center);
                    _view1._addColumn(__accountObject, 15, true, SMLReport._report._columnBorder.LeftRight, SMLReport._report._columnBorder.LeftRight, _g.d.gl_list_view._credit, _g.d.gl_list_view._table + "." + _g.d.gl_list_view._credit, _g.d.gl_list_view._credit, SMLReport._report._cellAlign.Center);
                    return true;
                }
            return false;
        }
        ...
        bool _view1__loadData()
        {
            ...
            if (__getFromProcess == null)
            {
                ...
                __getFromProcess = __process._glViewJounalDetailSum(_conditionDateEnd, _chartOfAccountTreeView, this._conditionAllAccount, this._conditionAccountBalance,0);
            }
