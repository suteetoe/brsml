...
{
    public partial class _report_add_goods_cancel : UserControl
    {
        ...
        public _report_add_goods_cancel()
        {
            InitializeComponent();
        ...
        public void _po_config()
        {
            ...
            this._report_name = "รายงานยกเลิกการเพิ่มหนี้/ราคาผิด/เพิ่มสินค้า";//_apReportName(_apType);
            //001-008
            ...
            string __toDoc = "";
            string _data_query = "";
            this.__query.Append("select doc_no,doc_date,doc_ref,doc_ref_date,remark,cust_code,( select name_1 from ap_supplier where ap_supplier.code = cust_code) as ar_name  from ic_trans  where trans_flag = 15 ");
            if (this.__check_submit)
            {
        ...
        void _showCondition()
        {
            ...
            if (this._con_po == null)
            {
                ...
                this._con_po = new _condition_po(0, "  trans_flag = 15 ");
