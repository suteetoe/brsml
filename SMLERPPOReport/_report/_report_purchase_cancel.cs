...
{
    public partial class _report_purchase_cancel : UserControl
    {
        ...
        public _report_purchase_cancel()
        {
            InitializeComponent();
        ...
        public void _po_config()
        {
            ...
            this._report_name = "รายงานยกเลิกการรับสินค้า/ตั้งหนี้";//_apReportName(_apType);
            //001-008
            ...
            string __toDoc = "";
            string _data_query = "";
            this.__query.Append("select doc_no,doc_date,doc_ref,doc_ref_date,remark,cust_code,( select name_1 from ap_supplier where ap_supplier.code = cust_code) as ar_name  from ic_trans  where trans_flag = 13 ");
            if (this.__check_submit)
            {
        ...
        void _showCondition()
        {
            ...
            if (this._con_po == null)
            {
                ...
                this._con_po = new _condition_po(0, "  trans_flag = 13 ");
