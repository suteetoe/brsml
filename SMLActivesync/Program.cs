                ...
                try
                {
                    ...
                    if (__autoLogin)
                    {
                        ...
                        if (__loginSuccess)
                        {
                            ...
                            if (__computerName.IndexOf("jead8") != -1 || __computerName.IndexOf("s2") != -1)
                            {
                                MyLib._myGlobal._webServiceServerList.Clear();
                                ...
                                /*MyLib._myGlobal._providerCode = "SEAANDHILL";// "UAT"; // "sql";
                                MyLib._myGlobal._databaseName = "p54_114_sahasakroo"; // "UAT1"; // "sqltest1";
                                MyLib._myGlobal._nonPermission = true;
                                MyLib._myGlobal._password = "superadmin"; // "029649744"; //"1"; //  */

                                /*MyLib._myGlobal._providerCode = "BOOKCENTER"; // "BOOKCENTER"; // "UAT";// "UAT"; // "sql";
                                MyLib._myGlobal._databaseName = "SBC002"; // "SBC002"; //"KK";// "SBC003"; // "UAT1"; // "sqltest1";
                                MyLib._myGlobal._nonPermission = true;
                                MyLib._myGlobal._password = "1111"; // "1111"; // "029649744"; // "029649744"; //"1"; //  
                                */
                                /*
                                MyLib._myGlobal._providerCode = "UAT"; // "BOOKCENTER"; // "UAT";// "UAT"; // "sql";
                                MyLib._myGlobal._databaseName = "PCAIR4"; // "UAT1"; //  "SBC002"; //"KK";// "SBC003"; // "UAT1"; // "sqltest1";
                                MyLib._myGlobal._nonPermission = true;
                                MyLib._myGlobal._password = "029649744"; // "1111"; // "029649744"; // "029649744"; //"1"; //  
                                */

                                MyLib._myGlobal._providerCode = "BALANCE"; // "BOOKCENTER"; // "UAT";// "UAT"; // "sql";
                                MyLib._myGlobal._databaseName = "BALDATACENTER"; // "UAT1"; //  "SBC002"; //"KK";// "SBC003"; // "UAT1"; // "sqltest1";
                                MyLib._myGlobal._nonPermission = true;
                                MyLib._myGlobal._password = "029649744"; // "1111"; // "029649744"; // "029649744"; //"1"; //  
