...
{
    public partial class _report_po_purchase_explain_by_tax : UserControl
    {
        private SMLReport._report._objectListType __detailObject;
        private DataTable _dataTable;

        public _report_po_purchase_explain_by_tax()
        {
            InitializeComponent();
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            ...
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                this._view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "รายงานการซื้อสินค้าแจกแจงตามประเภทภาษี", SMLReport._report._cellAlign.Left, this._view1._fontHeader2);
            ...
            else if (type == SMLReport._report._objectType.Detail)
            {
                ...
                this._view1._addColumn(__detailObject, 8, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "เลขที่ใบกำกับภาษี", "", SMLReport._report._cellAlign.Left);
                ...
                this._view1._addColumn(__detailObject, 12, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ชื่อสินค้า", "", SMLReport._report._cellAlign.Left);
        ...
        void _view1__getDataObject()
        {
            ...
            for (int __row = 0; __row < __dataRows.Length; __row++)
            {
                ...
                this._view1._addDataColumn(__detailObject, __dataObject, 11, __dataRows[__row].ItemArray[11].ToString(), __newFont, SMLReport._report._cellAlign.Right, 0,SMLReport._report._cellType.Number);
