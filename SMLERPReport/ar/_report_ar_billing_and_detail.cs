...
{
    public partial class _report_ar_billing_and_detail : UserControl
    {
        ...
        private string _from_bill;
        private string _to_bill;
        ...
        public _report_ar_billing_and_detail()
        {
            InitializeComponent();
        ...
        void _view1__loadDataByThread()
        {
            if (this._dataTable == null || this._dataTableDetail == null)
            {
                ...
                {
                    //where screen===========================================================================================
                    __getWhereScreen.Append(String.Format("({0}=2) and ({1}=35) and ({2} between \'{3}\' and \'{4}\')",
                        _g.d.ap_ar_trans._trans_type,
                        _g.d.ap_ar_trans._trans_flag,
                        _g.d.ap_ar_trans._doc_date,
                        this._from_date,
                        this._to_date));
                    if (this._from_bill.Trim().Length > 0)
                    {
                    ...
                    __query = String.Format("select {0},{1},{2},{3},{4},{5},{6} from {7} where {8} {9}",
                        ...
                        _g.d.ap_ar_trans._due_date,                                                         //{2}
                        _g.d.ap_ar_trans._cust_code,                                                        //{3}
                        "(select name_1 from ar_customer where code=ap_ar_trans.cust_code) as cust_name",   //{4}
                    ...
                    __query = String.Format("select {1},{2},{3},{4},{5},{6},{7} from ({8}) as {0} where {9} {10} {11}",
                        ...
                        _g.d.ap_ar_trans._due_date,                                                         //{3}
                        _g.d.ap_ar_trans._cust_code,                                                        //{4}
                        "cust_name",                                                                        //{5}
                        _g.d.ap_ar_trans._remark,                                                           //{6}
                        ...
                        __orderBy);                                                                         //{11}
                    //where detail===========================================================================================
                    __getWhereDetail = String.Format("({0}=2) and ({1}=35) and ({2} in (select {3} from ({4}) as {5}))",
                    ...
                    __queryDetail = String.Format("select {0},{1},{2},{3},{4},{5} from {6} where {7}",
                        ...
                        _g.d.ap_ar_trans_detail._remark,                                                    //{3}
                        _g.d.ap_ar_trans_detail._doc_group,                                                 //{4}
                        _g.d.ap_ar_trans_detail._sum_debt_value,                                            //{5}
                        _g.d.ap_ar_trans_detail._table,                                                     //{6}
                        __getWhereDetail);                                                                  //{7}

                    //__where1.Append(String.Format("({0}=2) and ({1}=35) and ({2} between \'{3}\' and \'{4}\')",
                    //    _g.d.ap_ar_trans._trans_type,
                    //    _g.d.ap_ar_trans._trans_flag,
                    //    _g.d.ap_ar_trans._doc_date,
                    //    this._from_date,
                    //    this._to_date));
                    //if (!this._from_bill.Equals("") && !this._to_bill.Equals(""))
                    //{
                    //    __where1.Append(String.Format(" and ({0} between \'{1}\' and \'{2}\')",
                    //        _g.d.ap_ar_trans._doc_no,
                    //        this._from_bill,
                    //        this._to_bill));
                    //}
                    ...
                    ////        this._toAr));
                    ////}
                    //if (!this._from_sale.Equals("") && !this._to_sale.Equals(""))
                    //{
                    //    __where1.Append(String.Format(" and ({0} between \'{1}\' and \'{2}\')",
                    //        _g.d.ap_ar_trans._sale_code,
                    //        this._from_sale,
                    ...
                    //}
                    ////whereDetail
                    //__whereDetail.Append(String.Format("({0}=2) and ({1}=35) and ({2} in {3})",
                    //    _g.d.ap_ar_trans_detail._trans_type,
                    //    _g.d.ap_ar_trans_detail._trans_flag,
                    //    _g.d.ap_ar_trans_detail._doc_no,
                    //    "(select doc_no from ap_ar_trans where " + __where1.ToString() + ")"));
                    ////order by
                    ...
                    //    __orderBy.ToString()));
                    ////queryDetail
                    //__queryDetail.Append(String.Format("select {0},{1},{2},{3},{4},{5} from {6} where {7}",
                    //    _g.d.ap_ar_trans_detail._doc_no,
                    ...
                    //    _g.d.ap_ar_trans_detail._sum_debt_value,
                    //    _g.d.ap_ar_trans_detail._table,
                    //    __whereDetail.ToString()));
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            ...
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                this._view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "Title\t: รายงานใบวางบิลพร้อมรายการย่อย", SMLReport._report._cellAlign.Left, this._view1._fontHeader2);
            ...
            else if (type == SMLReport._report._objectType.Detail)
            {
                ...
                this._view1._addColumn(__detailObject1, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "วันที่เอกสาร", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject1, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "เลขที่ใบวางบิล", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject1, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "วันทีครบกำหนด", "", SMLReport._report._cellAlign.Left);
                ...
                this._view1._addColumn(__detailObject1, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ชื่อลูกหนี้", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject1, 40, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "หมายเหตุ", "", SMLReport._report._cellAlign.Center);
                ...
                this._view1._addColumn(__detailObject2, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ใบส่งของ/ใบลดหนี้", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject2, 10, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "วันที่เอกสาร", "", SMLReport._report._cellAlign.Left);
                ...
                this._view1._addColumn(__detailObject2, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ประเภทเอกสาร", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject2, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "มูลค่าที่วางบิล", "", SMLReport._report._cellAlign.Right);
                return true;
            }
            return false;
        }
        ...
        void _view1__getDataObject()
        {
            ...
            for (int __row = 0; __row < __dataRows.Length; __row++)
            {
                ...
                this._view1._addDataColumn(__detailObject1, __dataObject, 5, __dataRows[__row].ItemArray[5].ToString(), __newFont, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
        ...
        private void _showCondition()
        {
            ...
            {
                this._form_condition = new _condition_ar_new(_enum_screen_report_ar.ar_billing.ToString());
            ...
            if (this._form_condition._process)
            {
                ...
                this._from_date = MyLib._myGlobal._convertDateToQuery(MyLib._myGlobal._convertDate(this._form_condition._screen_condition_ar_new1._getDataStr(_g.d.resource_report._from_invoice_date)));

                this._to_date = MyLib._myGlobal._convertDateToQuery(MyLib._myGlobal._convertDate(this._form_condition._screen_condition_ar_new1._getDataStr(_g.d.resource_report._to_invoice_date)));

                this._from_bill = this._form_condition._screen_condition_ar_new1._getDataStr(_g.d.resource_report._from_bill_of_landing_place);

                this._to_bill = this._form_condition._screen_condition_ar_new1._getDataStr(_g.d.resource_report._to_bill_of_landing_place);
