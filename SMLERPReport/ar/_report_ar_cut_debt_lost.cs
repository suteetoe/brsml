...
{
    public partial class _report_ar_cut_debt_lost : UserControl
    {
        ...
        private string[] _ar_detail_column = { _g.d.ap_ar_trans._table+"."+_g.d.ap_ar_trans._doc_no,
        ...
        public _report_ar_cut_debt_lost()
        {
            InitializeComponent();
        ...
        void _view1__loadDataByThread()
        {
            if (this._dataTable == null || this._dataTableDetail == null)
            {
                ...
                {
                    //where screen===========================================================================================
                    __getWhereScreen.Append(String.Format("({0}=2) and ({1}=41) and ({2} between \'{3}\' and \'{4}\')",
                    ...
                    //query==================================================================================================
                    __query = String.Format("select {0},{1},{2},{3},{4},{5} from {6} where {7} {8}",
                        ...
                        "(select name_1 from erp_user where code=ap_ar_trans.sale_code) as sale_name",      //{4}
                        _g.d.ap_ar_trans._total_net_value,                                                 //{5}
                        _g.d.ap_ar_trans._table,                                                            //{6}
                        __getWhereScreen,                                                                   //{7}
                        __getUserWhere1);                                                                   //{8}
                    __query = String.Format("select {1},{2},{3},{4},{5},{6} from ({7}) as {0} where {8} {9} {10}",
                        ...
                        __query,                                                                            //{7}
                        __getWhereGrid.ToString(),                                                          //{8}
                        __getUserWhere2,                                                                    //{9}
                        __orderBy);                                                                         //{10}
                    //where detail===========================================================================================
                    __getWhereDetail = String.Format("({0}=2) and ({1}=41) and ({2} in (select {3} from ({4}) as {5}))",
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            ...
            if (type == SMLReport._report._objectType.Header)
            {
                ...
                this._view1._addCell(__headerObject, __newColumn, true, 1, -1, SMLReport._report._cellType.String, "Title\t: รายงานการตัดหนี้สูญ", SMLReport._report._cellAlign.Left, this._view1._fontHeader2);
            ...
            else if (type == SMLReport._report._objectType.Detail)
            {
                ...
                this._view1._addColumn(__detailObject1, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "เลขที่เอกสาร", "", SMLReport._report._cellAlign.Left);
                ...
                this._view1._addColumn(__detailObject1, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "รหัสลูกหนี้", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject1, 25, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ชื่อลูกหนี้", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject1, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "พนักงานขาย", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject1, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ยอดตัดหนี้สูญ", "", SMLReport._report._cellAlign.Right);
                //พิมพ์ชื่อฟิลด์
                ...
                this._view1._addColumn(__detailObject2, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "เลขที่ใบส่งของ", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject2, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ลงวันที่", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject2, 20, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "วันที่ครบกำหนด", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject2, 25, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "รายวัน/คำอธิบาย", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(__detailObject2, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ยอดตัดจ่าย", "", SMLReport._report._cellAlign.Right);
                return true;
            }
            return false;
        }
        ...
        void _view1__getDataObject()
        {
            ...
            DataRow[] __dataRowsCutDebtLost = this._dataTable.Select();
            for (int __rowCutDebtLost = 0; __rowCutDebtLost < __dataRowsCutDebtLost.Length; __rowCutDebtLost++)
            {
                ...
                this._view1._addDataColumn(__detailObject1, __dataObject, 0, __dataRowsCutDebtLost[__rowCutDebtLost].ItemArray[0].ToString(), __newFont, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                this._view1._addDataColumn(__detailObject1, __dataObject, 1, __dataRowsCutDebtLost[__rowCutDebtLost].ItemArray[1].ToString(), __newFont, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                this._view1._addDataColumn(__detailObject1, __dataObject, 2, __dataRowsCutDebtLost[__rowCutDebtLost].ItemArray[2].ToString(), __newFont, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                this._view1._addDataColumn(__detailObject1, __dataObject, 3, __dataRowsCutDebtLost[__rowCutDebtLost].ItemArray[3].ToString(), __newFont, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                this._view1._addDataColumn(__detailObject1, __dataObject, 4, __dataRowsCutDebtLost[__rowCutDebtLost].ItemArray[4].ToString(), __newFont, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
                this._view1._addDataColumn(__detailObject1, __dataObject, 5, __dataRowsCutDebtLost[__rowCutDebtLost].ItemArray[5].ToString(), __newFont, SMLReport._report._cellAlign.Right, 0,SMLReport._report._cellType.Number);

                if (this._dataTableDetail.Rows.Count == 0) continue;
                DataRow[] __dataRowsDetail = this._dataTableDetail.Select(_g.d.ap_ar_trans_detail._doc_no + "='" + __dataRowsCutDebtLost[__rowCutDebtLost].ItemArray[0].ToString() + "'");
                for (int __rowDetail = 0; __rowDetail < __dataRowsDetail.Length; __rowDetail++)
                {
                    ...
                    this._view1._addDataColumn(__detailObject2, __dataObject, 3, __dataRowsDetail[__rowDetail].ItemArray[4].ToString(), __newFont, SMLReport._report._cellAlign.Default, 0,SMLReport._report._cellType.String);
