...
{
    public partial class _depreciateByYear : UserControl
    {
        public _depreciateByYear()
        {
            InitializeComponent();
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (__result.Count > 0)
                    {
                        ...
                        // Create Column
                        DateTime __yearColumnBegin = __getDateBegin;
                        DateTime __yearColumnEnd = __getDateEnd;
                        int __diffColumn = __yearColumnEnd.Year - __yearColumnBegin.Year;
                        ...
                        {
                            string __columnName = MyLib._myGlobal._convertDateToString(Convert.ToDateTime(__yearColumnBegin), false);
                            __columnName = __columnName.Substring(__columnName.Length - 4, 4);
                            this._myGrid1._addColumn(__columnName, 3, 0, 70, true, false, true, false, formatNumber);
                            __yearColumnBegin = cal.AddYears(__yearColumnBegin, 1);
                        }
