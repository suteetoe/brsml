...
{
    public partial class _depreciateByDay : UserControl
    {
        public _depreciateByDay()
        {
            InitializeComponent();
            ...
            //this._myGrid1._table_name = _g.d.as_resource._table;
            this._myGrid1._addColumn(_g.d.as_resource._table + "." + _g.d.as_resource._as_code, 1, 25, 20, true, false);
            this._myGrid1._addColumn(_g.d.as_resource._table + "." + _g.d.as_resource._as_name, 1, 100, 70, true, false);
            this._myGrid1._addColumn(_g.d.as_resource._table + "." + _g.d.as_resource._as_result, 3, 0, 10, true, false, true, false, formatNumber);
            //**************************
            this._myGrid1._setColumnBackground(_g.d.as_resource._table + "." + _g.d.as_resource._as_result, Color.AliceBlue);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (__result.Count > 0)
                    {
                        ...
                        // Create Column
                        DateTime __dateColumnBegin = __getDateBegin;
                        DateTime __dateColumnEnd = __getDateEnd;
                        TimeSpan __timeSpan = __dateColumnEnd.Subtract(__dateColumnBegin);
                        double __diffDate = __timeSpan.TotalDays;
                        int __diffColumn = (int)__diffDate;
                        this._myGrid1._clearGridColumn();
                        this._myGrid1._clear();
                        string formatNumber = MyLib._myGlobal._getFormatNumber("m02");
                        this._myGrid1._width_by_persent = false;
                        this._myGrid1._isEdit = false;
                        this._myGrid1._addColumn(_g.d.as_resource._table + "." + _g.d.as_resource._as_code, 1, 25, 100, true, false);
                        this._myGrid1._addColumn(_g.d.as_resource._table + "." + _g.d.as_resource._as_name, 1, 100, 250, true, false);
                        this._myGrid1._addColumn(_g.d.as_resource._table + "." + _g.d.as_resource._buy_price, 3, 0, 90, true, false, true, false, formatNumber);
                        this._myGrid1._addColumn(_g.d.as_resource._table + "." + _g.d.as_resource._as_come, 3, 0, 90, true, false, true, false, formatNumber);
                        for (int __col = 0; __col <= __diffColumn; __col++)
                        {
                            string __columnName = MyLib._myGlobal._convertDateToString(Convert.ToDateTime(__dateColumnBegin), false);
                            this._myGrid1._addColumn(__columnName, 3, 0, 100, true, false, true, false, formatNumber);
                            TimeSpan __timeSpanAdd = new TimeSpan(1, 0, 0, 0);
                            __dateColumnBegin = __dateColumnBegin.Add(__timeSpanAdd);
                        }
                        this._myGrid1._addColumn(_g.d.as_resource._table + "." +  _g.d.as_resource._as_result, 3, 0, 90, true, false, true, false, formatNumber);
                        this._myGrid1._addColumn(_g.d.as_resource._table + "." +  _g.d.as_resource._value_go, 3, 0, 90, true, false, true, false, formatNumber);
                        //this._myGrid1._calcPersentWidthToScatter();
                        //**************************
                        this._myGrid1._setColumnBackground(_g.d.as_resource._table + "." + _g.d.as_resource._buy_price, Color.AliceBlue);
                        this._myGrid1._setColumnBackground(_g.d.as_resource._table + "." + _g.d.as_resource._as_come, Color.AliceBlue);
                        this._myGrid1._setColumnBackground(_g.d.as_resource._table + "." + _g.d.as_resource._as_result, Color.AliceBlue);
                        this._myGrid1._setColumnBackground(_g.d.as_resource._table + "." + _g.d.as_resource._value_go, Color.AliceBlue);
