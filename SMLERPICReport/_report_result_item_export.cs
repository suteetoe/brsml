...
{
    public partial class _report_result_item_export : UserControl
    {
        _report_ic _report_ic1;
        public _report_result_item_export()
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Result_item_export;
