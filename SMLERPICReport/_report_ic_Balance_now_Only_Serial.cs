...
{
    public partial class _report_ic_Balance_now_Only_Serial : UserControl
    {
        private _report_ic _report_ic1;
        public _report_ic_Balance_now_Only_Serial()
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Item_Balance_now_Only_Serial;
