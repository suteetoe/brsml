...
{
    public partial class _report_ic_account_special : UserControl
    {
        private _report_ic _report_ic1;
        public _report_ic_account_special()
        {
            InitializeComponent(); 
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.สินค้า_รายงานบัญชีคุมพิเศษ;
