...
{
    public partial class _report_ic_serial_number : UserControl
    {
        _report_ic _report_ic1;
        public _report_ic_serial_number(string screenName)
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Serial_number;
            ...
            this._report_ic1._report_name = screenName;
            ...
            this._report_ic1._showCondition();
        }
