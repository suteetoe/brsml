...
{
    public partial class _report_ic_transfer_standard : UserControl
    {
        _report_ic _report_ic1;
        public _report_ic_transfer_standard()
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Item_transfer_standard;
