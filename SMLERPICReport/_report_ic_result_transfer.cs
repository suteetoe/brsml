...
{
    public partial class _report_ic_result_transfer : UserControl
    {
        _report_ic _report_ic1;
        public _report_ic_result_transfer()
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Result_transfer_item;
