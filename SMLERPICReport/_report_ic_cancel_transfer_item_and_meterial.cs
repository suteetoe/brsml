...
{
    public partial class _report_ic_cancel_transfer_item_and_meterial : UserControl
    {
        _report_ic _report_ic1;
        public _report_ic_cancel_transfer_item_and_meterial()
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Cancel_Transfer_Item_and_material;
