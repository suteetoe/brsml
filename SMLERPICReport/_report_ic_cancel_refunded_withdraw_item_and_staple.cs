...
{
    public partial class _report_ic_cancel_refunded_withdraw_item_and_staple : UserControl
    {
        _report_ic _report_ic1;

        public _report_ic_cancel_refunded_withdraw_item_and_staple()
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Cancel_Refunded_Withdraw_Item_Staple;
