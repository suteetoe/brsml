...
{
    public partial class _report_ic_cancel_implement_item_and_staple_over : UserControl
    {
        _report_ic _report_ic1;
        public _report_ic_cancel_implement_item_and_staple_over()
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Cancel_Implement_Item_and_Staple_Over;
