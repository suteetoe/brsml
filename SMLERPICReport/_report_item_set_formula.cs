...
{
    public partial class _report_item_set_formula : UserControl
    {
        ...
        public _report_item_set_formula(string screenName)
        {
        ...
        SMLReport._generateLevelClass _reportInitRoot(SMLReport._generateLevelClass levelParent, Boolean sumTotal, Boolean autoWidth)
        {
            ...
            __columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_set_detail._table + "." + _g.d.ic_inventory_set_detail._ic_set_code, null, 20, SMLReport._report._cellType.String, 0, FontStyle.Bold));
            __columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_set_detail._table + "." + _g.d.ic_inventory_set_detail._ic_set_name, null, 50, SMLReport._report._cellType.String, 0, FontStyle.Bold));
            __columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_set_detail._table + "." + _g.d.ic_inventory_set_detail._ic_set_unit, null, 30, SMLReport._report._cellType.String, 0, FontStyle.Bold));
        ...
        {
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_set_detail._table + "." + _g.d.ic_inventory_set_detail._ic_code, null, 20, SMLReport._report._cellType.String, 0, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_set_detail._table + "." + _g.d.ic_inventory_set_detail._ic_name, null, 45, SMLReport._report._cellType.String, 0, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_set_detail._table + "." + _g.d.ic_inventory_set_detail._unit_code, null, 20, SMLReport._report._cellType.String, 0, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_set_detail._table + "." + _g.d.ic_inventory_set_detail._qty, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_qty_decimal, FontStyle.Regular));
        }
        ...
        void _report__query()
        {
            if (this._dataTable == null)
            {
                try
                {
                    ...
                    __query.Append("unit_code,qty from ic_inventory_set_detail " + __where + " order by ic_inventory_set_detail.ic_set_code,line_number) as temp1  where ic_set_type=3" + this._form_condition._extra._getOrderBy());
                    //
                    string __queryStr = __query.ToString();
                    this._dataTableRoot = __myFrameWork._queryStream(MyLib._myGlobal._databaseName, __queryStr).Tables[0];                   
        ...
        private void _showCondition()
        {
            ...
            {
                this._report__init();
                this._form_condition = new SMLERPReportTool._conditionScreen(SMLERPReportTool._reportEnum.สินค้า_รายงานสูตรสินค้าชุด, this._screenName);
