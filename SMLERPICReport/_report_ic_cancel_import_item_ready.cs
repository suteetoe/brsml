...
{
    public partial class _report_ic_cancel_import_item_ready : UserControl
    {
        _report_ic _report_ic1;
        public _report_ic_cancel_import_item_ready()
        {
            InitializeComponent();
            this._report_ic1 = new _report_ic();
            this._report_ic1._icType = SMLERPReportTool._reportEnum.Cancel_Import_Item_ready;
