...
{
    public partial class _report_ic_purchase_price : UserControl
    {
        ...
        public _report_ic_purchase_price(string screenName)
        {
        ...
        {
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._supplier_name, null, 30, SMLReport._report._cellType.String, 0, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._unit_code, null, 10, SMLReport._report._cellType.String, 0, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._from_date, null, 10, SMLReport._report._cellType.DateTime, 0, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._to_date, null, 10, SMLReport._report._cellType.DateTime, 0, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._from_qty, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_qty_decimal, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._to_qty, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_qty_decimal, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._sale_price1, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_price_decimal, FontStyle.Regular));
            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._sale_price2, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_price_decimal, FontStyle.Regular));
        }
        ...
        void _report__query()
        {
            if (this._dataTable == null)
            {
                ...
                {
                    //
                    string __getWhere = this._form_condition._grid._createWhere(_g.d.ic_inventory_purchase_price._table + "." + _g.d.ic_inventory_purchase_price._ic_code);
                    ...
                    __query.Append("unit_code" + __query1.Replace(__fieldName, "unit_code") + " as \"ic_inventory_purchase_price.unit_code\",");
                    __query.Append("supplier_name as \"ic_inventory_purchase_price.supplier_name\",");
                    __query.Append("from_date as \"ic_inventory_purchase_price.from_date\",");
                    __query.Append("to_date as \"ic_inventory_purchase_price.to_date\",");
                    __query.Append("from_qty as \"ic_inventory_purchase_price.from_qty\",");
                    __query.Append("to_qty as \"ic_inventory_purchase_price.to_qty\",");
                    __query.Append("sale_price1 as \"ic_inventory_purchase_price.sale_price1\",");
                    __query.Append("sale_price2 as \"ic_inventory_purchase_price.sale_price2\"");
                    __query.Append(" from (select ");
                    __query.Append("ic_code,");
                    __query.Append("coalesce((select name_1 from ap_supplier where ap_supplier.code=ic_inventory_purchase_price.supplier_code),'') as supplier_name,");
                    __query.Append("(select name_1 from ic_inventory where ic_inventory.code=ic_inventory_purchase_price.ic_code) as ic_name,");
                    __query.Append("(select unit_standard from ic_inventory where ic_inventory.code=ic_inventory_purchase_price.ic_code) as ic_unit,");
                    __query.Append("unit_code,from_date,to_date,from_qty,to_qty,sale_price1,sale_price2 from ic_inventory_purchase_price " + __where + " order by ic_inventory_purchase_price.ic_code,from_date) as temp1 " + this._form_condition._extra._getOrderBy());
                    //
        ...
        private void _showCondition()
        {
            ...
            {
                this._report__init();
                this._form_condition = new SMLERPReportTool._conditionScreen(SMLERPReportTool._reportEnum.สินค้า_รายงานราคาซื้อสินค้า, this._screenName);
                this._form_condition._extra._tableName = _g.d.ic_inventory_purchase_price._table;
