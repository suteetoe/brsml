...
{
    public partial class _expenses_list : UserControl
    {
        MyLib._myFrameWork _myFrameWork = new MyLib._myFrameWork();
        MyLib._searchDataFull _searchGLAccount = new MyLib._searchDataFull();
        
        string _searchName = "";
        TextBox _searchTextBox;
        public _expenses_list()
        {
            InitializeComponent();
            ...
            _myManageData1._dataList._loadViewFormat("screen_erp_expenses_list", MyLib._myGlobal._userSearchScreenGroup, true);
            _myManageData1._dataList._referFieldAdd(_g.d.erp_expenses_list._code, 1);
            ...
            this._expenselistScreen1._saveKeyDown += new MyLib.SaveKeyDownHandler(_expenselistScreen1__saveKeyDown);
            this._expenselistScreen1._checkKeyDown += new MyLib.CheckKeyDownHandler(_expenselistScreen1__checkKeyDown);
        ...
        Boolean _expenselistScreen1__checkKeyDown(object sender, Keys keyData)
        {
        ...
        void _save_data()
        {
            _expenselistScreen1._saveLastControl();
            string getEmtry = _expenselistScreen1._checkEmtryField();
            ...
            {
                ArrayList __getData = _expenselistScreen1._createQueryForDatabase();
                ...
                if (result.Length == 0)
                {
                    ...
                    _expenselistScreen1._clear();
                    _expenselistScreen1._focusFirst();
                }
                else
                {
        ...
        {
            Control codeControl = _expenselistScreen1._getControl(_g.d.erp_expenses_list._code);
            codeControl.Enabled = true;
            _expenselistScreen1._focusFirst();
        }

        void _expenselistScreen1__saveKeyDown(object sender)
        {
            _save_data();
        }
        ...
        {
            bool result = true;
            if (_expenselistScreen1._isChange)
            {
                ...
                {
                    _expenselistScreen1._isChange = false;
                }
            }
            return (result);
        }
        ...
        bool _myManageData1__loadDataToScreen(object rowData, string whereString, bool forEdit)
        {
            try
            {
                ...
                _expenselistScreen1._loadData(getData.Tables[0]);
                Control codeControl = _expenselistScreen1._getControl(_g.d.erp_expenses_list._code);
    ...
    public partial class _expenselistScreen : MyLib._myScreen
    {
        public _expenselistScreen()
        {
            this._maxColumn = 1;
            this.SuspendLayout();
            this._table_name = _g.d.erp_expenses_list._table;
            this._addTextBox(0, 0, 1, 0, _g.d.erp_expenses_list._code, 1, 25, 0, true, false, false);
            this._addTextBox(1, 0, 1, 0, _g.d.erp_expenses_list._name_1, 1, 25, 0, true, false, false);
            this._addTextBox(2, 0, 1, 0, _g.d.erp_expenses_list._name_2, 1, 25, 0, true, false, true);
            this._addTextBox(3, 0, 1, 0, _g.d.erp_expenses_list._gl_account_code, 1, 25, 1, true, false, true);
            this.ResumeLayout();
        }
    }
}
