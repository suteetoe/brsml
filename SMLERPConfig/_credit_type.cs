...
{
    public partial class _credit_type : UserControl
    {
        ...
        public _credit_type()
        {
            ...
            _myManageData1._dataList._loadViewFormat("screen_erp_credit_type", MyLib._myGlobal._userSearchScreenGroup, true);
            _myManageData1._dataList._referFieldAdd(_g.d.erp_credit_type._code, 1);
            ...
            this._credittypeScreen1._saveKeyDown += new MyLib.SaveKeyDownHandler(_credittypeScreen1__saveKeyDown);
            this._credittypeScreen1._checkKeyDown += new MyLib.CheckKeyDownHandler(_credittypeScreen1__checkKeyDown);
        ...
        Boolean _credittypeScreen1__checkKeyDown(object sender, Keys keyData)
        {
        ...
        void _save_data()
        {
            _credittypeScreen1._saveLastControl();
            string getEmtry = _credittypeScreen1._checkEmtryField();
            ...
            {
                ArrayList __getData = _credittypeScreen1._createQueryForDatabase();
                ...
                if (result.Length == 0)
                {
                    ...
                    _credittypeScreen1._clear();
                    _credittypeScreen1._focusFirst();
                }
                else
                {
        ...
        {
            Control codeControl = _credittypeScreen1._getControl(_g.d.erp_credit_type._code);
            codeControl.Enabled = true;
            _credittypeScreen1._focusFirst();
        }

        void _credittypeScreen1__saveKeyDown(object sender)
        {
            _save_data();
        }
        ...
        {
            bool result = true;
            if (_credittypeScreen1._isChange)
            {
                ...
                {
                    _credittypeScreen1._isChange = false;
                }
            }
            return (result);
        }
        ...
        bool _myManageData1__loadDataToScreen(object rowData, string whereString, bool forEdit)
        {
            try
            {
                ...
                _credittypeScreen1._loadData(getData.Tables[0]);
                Control codeControl = _credittypeScreen1._getControl(_g.d.erp_credit_type._code);
    ...
    public partial class _credittypeScreen : MyLib._myScreen
    {
        public _credittypeScreen()
        {
            this._maxColumn = 1;
            this.SuspendLayout();
            this._table_name = _g.d.erp_credit_type._table;
            this._addTextBox(0, 0, 1, 0, _g.d.erp_credit_type._code, 1, 25, 0, true, false, false);
            this._addTextBox(1, 0, 1, 0, _g.d.erp_credit_type._name_1, 1, 25, 0, true, false, false);
            this._addTextBox(2, 0, 1, 0, _g.d.erp_credit_type._name_2, 1, 25, 0, true, false, true);          
            this._addNumberBox(3, 0, 1, 0, _g.d.erp_credit_type._charge_rate, 1, 2, true);   
            this.ResumeLayout();
        }
    }
}
