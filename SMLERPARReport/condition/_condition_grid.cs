...
namespace SMLERPARAPReport.condition
{
    public partial class _condition_grid : MyLib._myGrid
    {
        ...
        void _condition_grid__clickSearchButton(object sender, MyLib.GridCellEventArgs e)
        {
            ...
            if (this._search_screen.Equals(_g.g._search_screen_ar))
            {
                string __searchBoxLabel = MyLib._myResource._findResource(_g.d.resource_report._table + "." + _g.d.resource_report._search_ar, _g.d.resource_report._table + "." + _g.d.resource_report._search_ar)._str;
                MyLib._myGlobal._startSearchBox(this._inputTextBox, __searchBoxLabel, this._search_data_full, true);
            }
            if (this._search_screen.Equals(_g.g._search_screen_ap))
            {
                string __searchBoxLabel = MyLib._myResource._findResource(_g.d.resource_report._table + "." + _g.d.resource_report._search_ar, _g.d.resource_report._table + "." + _g.d.resource_report._search_ap)._str;
                MyLib._myGlobal._startSearchBox(this._inputTextBox, __searchBoxLabel, this._search_data_full, true);
            }
        }
        ...
        SMLERPARAPInfo._apArEnum _mode;
        public void _setFromToColumn(SMLERPARAPInfo._apArConditionEnum mode, string __from_column_name, string __to_column_name)
        {
            this._mode = SMLERPARAPInfo._apAr._apArCheck(mode);
            this._clear();
        ...
        public DataTable _getCondition()
        {
            ...
            for (int __row = 0; __row < this._rowCount(0); __row++)
            {
                ...
                if (__dataRow[1].ToString().Trim().Length == 0) __dataRow[1] = __dataRow[0];
