...
{
    public partial class _debt_cut_off : UserControl
    {
        ...
        private string _title = MyLib._myResource._findResource(_g.d.resource_report_name._table + "." + _g.d.resource_report_name._ap_billing, "รายงานการตัดหนี้สูญ")._str;
        ...
        void _view1__loadDataByThread()
        {
            if (this._dataTable == null || this._dataTableDetail == null)
            {
                ...
                {
                    //where screen===========================================================================================
                    __getWhereScreen.Append(String.Format("({0}=41) and ({1} between \'{2}\' and \'{3}\')",
                    ...
                    //SubQuery
                    __arSubQuery = String.Format("(select {2} from {0} where {1}={3}.{4}) as cust_name",
        ...
        bool _view1__getObject(System.Collections.ArrayList objectList, SMLReport._report._objectType type)
        {
            ...
            else if (type == SMLReport._report._objectType.Detail)
            {
                ...
                this._view1._addColumn(this._detailObject1, 15, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "รหัสลูกหนี้", "", SMLReport._report._cellAlign.Left);
                this._view1._addColumn(this._detailObject1, 25, true, SMLReport._report._columnBorder.None, SMLReport._report._columnBorder.None, "", "ชื่อลูกหนี้", "", SMLReport._report._cellAlign.Left);
        ...
        private void _showCondition()
        {
            ...
            {
                this._form_condition = new _condition_form(SMLERPARAPInfo._apArConditionEnum.debt_cut_off, SMLERPARAPInfo._apArConditionEnum.debt_cut_off.ToString(), this._title);
