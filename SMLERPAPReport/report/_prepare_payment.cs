...
{
    public partial class _prepare_payment : UserControl
    {
        ...
        private string _title = MyLib._myResource._findResource(_g.d.resource_report_name._table + "." + _g.d.resource_report_name._ap_detail, "รายงานการเตรียมจ่ายชำระหนี้")._str;
        ...
        void _view1__loadDataByThread()
        {
            if (this._dataTable == null || this._dataTableDetail == null)
            {
                ...
                {
                    //where screen===========================================================================================
                    __getWhereScreen.Append(String.Format("({0}=15) and ({1} between \'{2}\' and \'{3}\')",
