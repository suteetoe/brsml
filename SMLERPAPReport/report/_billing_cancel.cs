...
namespace SMLERPAPReport.report
{
    public partial class _billing_cancel : UserControl
    {
        ...
        private string _title = MyLib._myResource._findResource(_g.d.resource_report_name._table + "." + _g.d.resource_report_name._ap_billing_cancel, _g.d.resource_report_name._table + "." + _g.d.resource_report_name._ap_billing_cancel)._str;
        ...
        void _view1__loadDataByThread()
        {
            if (this._dataTable == null || this._dataTableDetail == null)
            {
                ...
                {
                    //where screen===========================================================================================
                    __getWhereScreen.Append(String.Format("({0}=14) and ({1} between \'{2}\' and \'{3}\')",
        ...
        void _view1__getDataObject()
        {
            ...
            for (int __row = 0; __row < __dataRows.Length; __row++)
            {
                ...
                this._view1._addDataColumn(this._detailObject1, __dataObject, 8, MyLib._myGlobal._formatNumberForReport(_g.g._companyProfile._item_amount_decimal, __dataRows, __row, _g.d.ap_ar_trans._total_discount), __newFont, SMLReport._report._cellAlign.Right, 0,SMLReport._report._cellType.Number);
        ...
        private void _showCondition()
        {
            ...
            {
                this._form_condition = new _condition_form(_enum_screen_report_ap.billing_cancel.ToString(), this._title);
