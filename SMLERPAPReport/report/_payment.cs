...
{
    public partial class _payment : UserControl
    {
        ...
        private string _title = MyLib._myResource._findResource(_g.d.resource_report_name._table + "." + _g.d.resource_report_name._ap_payment, _g.d.resource_report_name._table + "." + _g.d.resource_report_name._ap_payment)._str;
        ...
        void _view1__loadDataByThread()
        {
            if (this._dataTable == null || this._dataTableDetail == null)
            {
                ...
                {
                    //where screen===========================================================================================
                    __getWhereScreen.Append(String.Format("({0}=19) and ({1} between \'{2}\' and \'{3}\')",
        ...
        void _view1__getDataObject()
        {
            ...
            for (int __row = 0; __row < __dataRows.Length; __row++)
            {
                ...
                if (__cancelDocument == 0) this._sum4 += __value;
