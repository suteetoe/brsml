...
{
    /// <summary>
    /// Represents a dialog containing a <see cref="_frmPrintPreviewControll"/> control
    ...
    /// PDF export.
    /// </remarks>
    internal partial class _frmPrintPreviewDialogControl : UserControl
    {
        //--------------------------------------------------------------------
        #region ** fields
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="_frmPrintPreviewDialogControl"/>.
        /// </summary>
        public _frmPrintPreviewDialogControl() : this(null)
        {
        }
        /// <summary>
        /// Initializes a new instance of a <see cref="_frmPrintPreviewDialogControl"/>.
        ...
        public _frmPrintPreviewDialogControl(Control parentForm)
        {
            InitializeComponent();
        ...
        void _btnPageSetup_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    dlg.Document = Document;
                   // dlg.PrinterSettings.PrinterName = _global.__printerSelectedName;
                    if (dlg.ShowDialog(this) == DialogResult.OK)
                    {
