...
{
    /// <summary>
    /// Specifies the zoom mode for the <see cref="_frmPrintPreviewControll"/> control.
    /// </summary>
    internal enum ZoomMode
    {
        ...
        TwoPages,
        /// <summary>
        /// Use the zoom factor specified by the <see cref="_frmPrintPreviewControll.Zoom"/> property.
        /// </summary>
        Custom
    }
    ...
    /// </remarks>
    internal class _frmPrintPreviewControl : UserControl
    {
        //-------------------------------------------------------------
        #region ** fields
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="_frmPrintPreviewControl"/> control.
        /// </summary>
        public _frmPrintPreviewControl()
        {
        ...
        internal class DocumentPrinter : PrintDocument
        {
            ...
            public DocumentPrinter(_frmPrintPreviewControl preview, int first, int last)
            {
        ...
        private void InitializeComponent()
        {
            ...
            this.SuspendLayout();
            // 
            // _frmPrintPreviewControl
            // 
            this.Name = "_frmPrintPreviewControl";
