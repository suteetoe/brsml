...
{
    public class ap_ar_trans_screen_more : MyLib._myScreen
    {
        ...
        {
            this._setDataStr(_g.d.ap_ar_trans._branch_code, MyLib._myGlobal._branchCode);
        }
        ...
        void _build()
        {
            ...
            this._textBoxSearch += ap_ar_trans_screen_more__textBoxSearch;            
        }

        void ap_ar_trans_screen_more__textBoxSearch(object sender)
        {
            // start search
        ...
        public ap_ar_trans_screen_more()
        {
