...
{
    public class _incomeGridControl : MyLib._myGrid
    {
        public delegate void _refreshDataEvent(_incomeGridControl sender);
        ...
        public _incomeGridControl()
        {
            this._table_name = _g.d.cb_trans_detail._table;

            this._addColumn(_g.d.cb_trans_detail._trans_number, 1, 1, 14, true, false, true, true, "", "", "", _g.d.cb_trans_detail._income_code);
            ...
            this._totalCheck += _incomeGridControl__totalCheck;
            this._alterCellUpdate += _incomeGridControl__alterCellUpdate;
            this._clickSearchButton += _incomeGridControl__clickSearchButton;
            this._afterRemoveRow += _incomeGridControl__afterRemoveRow;

            this._calcPersentWidthToScatter();

        }

        void _incomeGridControl__afterRemoveRow(object sender)
        {
        ...
        void _incomeGridControl__clickSearchButton(object sender, MyLib.GridCellEventArgs e)
        {

            string __queryWhere = "";
            if (e._columnName.Equals(_g.d.cb_trans_detail._trans_number))
            {
                _search_data_full_name = _g.g._search_screen_income_list;
                __queryWhere = "";
                //
        ...
        void _gridData__mouseClick(object sender, MyLib.GridCellEventArgs e)
        {
            ...
            if (this._search_data_full_pointer._name.Equals(_g.g._search_screen_income_list))
            {
                __result = this._search_data_full_pointer._dataList._gridData._cellGet(e._row, _g.d.erp_income_list._table + "." + _g.d.erp_income_list._code).ToString();
        ...
        private void _searchByParent(MyLib._myGrid sender, int row)
        {
            ...
            if (__getParent2._name.Equals(_g.g._search_screen_income_list))
            {
                string result = (string)this._search_data_full_pointer._dataList._gridData._cellGet(row, _g.d.erp_income_list._table + "." + _g.d.erp_income_list._code);
                if (result.Length > 0)
                {
                    this._search_data_full_pointer.Close();
        ...
        void _incomeGridControl__alterCellUpdate(object sender, int row, int column)
        {
        ...
        bool _incomeGridControl__totalCheck(object sender, int row, int column)
        {
            bool __result = true;
        ...
        void _search_detailRow(int row)
        {
            ...
            string __query = "select " + _g.d.erp_income_list._name_1 + " from " + _g.d.erp_income_list._table + " where " + MyLib._myGlobal._addUpper(_g.d.erp_income_list._code) + "=\'" + __code.ToUpper() + "\' ";
            ...
            {
                this._cellUpdate(row, _g.d.cb_trans_detail._description, __getData.Tables[0].Rows[0][_g.d.erp_income_list._name_1].ToString(), false);
            }
        }
    }
}
