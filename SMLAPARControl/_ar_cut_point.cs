...
namespace SMLERPAPARControl
{
    public partial class _ar_cut_point : UserControl
    {
        ...
        {
            string __result = _g.d.ic_trans._trans_flag + "=" + _g.g._transFlagGlobal._transFlag(_g.g._transControlTypeEnum.ลูกหนี้_ลดแต้ม).ToString();
        ...
        void _save_data()
        {
            ...
            string _queryPoint = "insert into " + _g.d.ic_trans._table + "(" + __fieldList[0].ToString() + "," + _g.d.ic_trans._trans_flag + "," + _g.d.ic_trans._last_status + ") values(" + __fieldList[1].ToString() + ", " + _g.g._transFlagGlobal._transFlag(_g.g._transControlTypeEnum.ลูกหนี้_ลดแต้ม).ToString() + ",0)";
        ...
        void _ar_point_balance_screen__textBoxChanged(object sender, string name)
        {
            ...
            else if (name.Equals(_g.d.ic_trans._doc_no))
            {
                ...
                if (__getFormat.Rows.Count > 0)
                {
                    ...
                    string __newDoc = _g.g._getAutoRun(_g.g._autoRunType.ข้อมูลรายวัน, __docNo, this._ar_point_balance_screen1._getDataStr(_g.d.ic_trans._doc_date).ToString(), __format, _g.g._transControlTypeEnum.ลูกหนี้_ลดแต้ม, _g.g._transControlTypeEnum.ว่าง, _g.d.ic_trans._table, __startRunningNumber);
