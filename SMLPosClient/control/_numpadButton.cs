...
{
    public partial class _numpadButton : UserControl
    {
        public delegate void _numpadClickHandler(object __sender, string __buttonText);
        public event _numpadClickHandler _numpadClick;
        ...
        public MyLib.VistaButton _button09
        {
            set { this.vistaButton9 = value; }
            get { return this.vistaButton9; }
        }
        
        public MyLib.VistaButton _button10
        {
            set { this.vistaButton10 = value; }
            get { return this.vistaButton10; }
        }
        
        public MyLib.VistaButton _button11
        {
            set { this.vistaButton11 = value; }
            get { return this.vistaButton11; }
        }
        
        public MyLib.VistaButton _button12
        {
            set { this.vistaButton12 = value; }
            get { return this.vistaButton12; }
        }
        
        public _numpadButton()
        {
            InitializeComponent();
        ...
        {
            if (this._numpadClick != null)
            {
                MyLib.VistaButton __getButton = (MyLib.VistaButton)sender;
                this._numpadClick(sender, __getButton.ButtonText);
            }
        }
    }
}
