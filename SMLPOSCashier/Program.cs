        ...
        public static void Main()
        {
            ...
            else
            {
                try
                {
                    ...
                    MyLib._myGlobal._programName = "SML POS Cashier";
                    ...
                    if (__autoLogin)
                    {
                        ...
                        if (__loginSuccess)
                        {
                            ...
                            if (__computerName.IndexOf("jead") != -1)
                            {
                                ...
                                */
                                MyLib._myGlobal._providerCode = "UAT";// "UAT"; // "sql";
                                MyLib._myGlobal._databaseName = "SBC002"; // "UAT1"; // "sqltest1";
                                MyLib._myGlobal._nonPermission = true;
                                MyLib._myGlobal._password = "029649744"; //"1"; //  
                            }
                            ...
                            if (__computerName.IndexOf("toe-pc") != -1)
                            {
                                ...
                                if (__dialogLocal == DialogResult.Yes)
                                {
                                    ...
                                    if (MyLib._myGlobal._isVersionEnum == MyLib._myGlobal._versionType.SMLTomYumGoong)
                                    {
                                        ...
                                        MyLib._myGlobal._databaseName = "postomyumgoong";
                                    }
                                    else
                                    {
                                        MyLib._myGlobal._providerCode = "BAL";
