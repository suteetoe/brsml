namespace ZetaHtmlEditControl
{
        ...
        IDisposable
    {
            ...
            string htmlCode)
        {
            ...
            htmlCode = htmlCode.Replace(@"&Auml;", @"ฤ");
            htmlCode = htmlCode.Replace(@"&absp;", @"ไ");
            htmlCode = htmlCode.Replace(@"&obsp;", @"๖");
            htmlCode = htmlCode.Replace(@"&Obsp;", @"ึ");
            htmlCode = htmlCode.Replace(@"&ubsp;", @"");
            htmlCode = htmlCode.Replace(@"&Ubsp;", @"");
            htmlCode = htmlCode.Replace(@"&szlig;", @"฿");

            htmlCode = htmlCode.Replace(@"&pound;", @"ฃ");
            htmlCode = htmlCode.Replace(@"&sect;", @"ง");
            htmlCode = htmlCode.Replace(@"&copy;", @"ฉ");
            htmlCode = htmlCode.Replace(@"&reg;", @"ฎ");
            htmlCode = htmlCode.Replace(@"&micro;", @"ต");
            htmlCode = htmlCode.Replace(@"&para;", @"ถ");
            htmlCode = htmlCode.Replace(@"&Oslash;", @"ุ");
            htmlCode = htmlCode.Replace(@"&oslash;", @"๘");
            htmlCode = htmlCode.Replace(@"&divide;", @"๗");
            htmlCode = htmlCode.Replace(@"&times;", @"ื");
            return htmlCode;
        }
        ...
        */
        ...
        internal void ExecuteInsertImage()
        {
            if (Document != null)
            {
                var doc = (HTMLDocument)Document.DomDocument;
