...
{
    public partial class M_congenital_disease : UserControl
    {
        MyLib._myFrameWork _myFrameWork = new MyLib._myFrameWork();
        public M_congenital_disease()
        {
            InitializeComponent();
            this.SuspendLayout();
            ...
            _myManageData1._dataList._loadViewFormat(_g.g._search_screen_healthy_congenital_disease, MyLib._myGlobal._userSearchScreenGroup, true);
            _myManageData1._dataList._referFieldAdd(_g.d.m_congenital_disease._ar_code, 1);
            _myManageData1._dataList._referFieldAdd(_g.d.m_congenital_disease._disease, 1);
            ...
            this._healthy_congenital_disease._saveKeyDown += new MyLib.SaveKeyDownHandler(_healthy_consultation__saveKeyDown);
        ...
        {
            myGrid._addColumn(_g.d.m_congenital_disease._table + "." + _g.d.m_congenital_disease._disease, 1, 100, 0, true, true);
        }
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if ((keyData & Keys.Control) == Keys.Control)
            {
                switch (keyCode)
                {
                    case Keys.Home:
                        {
                            this._healthy_congenital_disease._focusFirst();
                            return true;
                        }
                }
            }
        ...
        {
            string getEmtry = this._healthy_congenital_disease._checkEmtryField();
            ...
            else
            {
                ...
                //}
                ArrayList __getData = this._healthy_congenital_disease._createQueryForDatabase();
                ...
                if (result.Length == 0)
                {
                    ...
                    this._healthy_congenital_disease._isChange = false;
                    if (_myManageData1._mode == 1)
                    {
                    ...
                    this._healthy_congenital_disease._clear();
                    this._healthy_congenital_disease._focusFirst();
                }
                else
                {
        ...
        {
            this._healthy_congenital_disease._clear();
            Control codeControl = this._healthy_congenital_disease._getControl(_g.d.m_congenital_disease._ar_code);
        ...
        {
            bool result = true;
            if (this._healthy_congenital_disease._isChange)
            {
        ...
        bool _myManageData1__loadDataToScreen(object rowData, string whereString, bool forEdit)
        {
            try
            {
                ...
                this._healthy_congenital_disease._loadData(getData.Tables[0]);
                Control codeControl = this._healthy_congenital_disease._getControl(_g.d.m_congenital_disease._ar_code);
                codeControl.Enabled = false;
                this._healthy_congenital_disease._search(false);
                this._healthy_congenital_disease._isChange = false;
                if (forEdit)
                {
                    this._healthy_congenital_disease._focusFirst();
