...
{
    public partial class M_Consultation : UserControl
    {
        ...
        public M_Consultation()
        {
            ...
            _myManageData1._dataList._loadViewFormat(_g.g._search_screen_healthy_consultation, MyLib._myGlobal._userSearchScreenGroup, true);
            _myManageData1._dataList._referFieldAdd(_g.d.m_consultation._ic_code, 1);
            _myManageData1._dataList._referFieldAdd(_g.d.m_consultation._record_date,2);
            ...
            this._healthy_consultation._saveKeyDown += new MyLib.SaveKeyDownHandler(_healthy_consultation__saveKeyDown);
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if ((keyData & Keys.Control) == Keys.Control)
            {
                switch (keyCode)
                {
                    case Keys.Home:
                        {
                            this._healthy_consultation._focusFirst();
                            return true;
                        }
                }
            }
        ...
        {
            string getEmtry = this._healthy_consultation._checkEmtryField();
            ...
            else
            {
                    ...
                    //}
                    ArrayList __getData = this._healthy_consultation._createQueryForDatabase();
                    ...
                    if (result.Length == 0)
                    {
                        ...
                        this._healthy_consultation._isChange = false;
                        if (_myManageData1._mode == 1)
                        {
                        ...
                        this._healthy_consultation._clear();
                        this._healthy_consultation._focusFirst();
                    }
                    else
                    {
        ...
        {
            this._healthy_consultation._clear();
            Control codeControl = this._healthy_consultation._getControl(_g.d.m_consultation._ic_code);
        ...
        {
            bool result = true;
            if (this._healthy_consultation._isChange)
            {
        ...
        bool _myManageData1__loadDataToScreen(object rowData, string whereString, bool forEdit)
        {
            try
            {
                ...
                this._healthy_consultation._loadData(getData.Tables[0]);
                Control codeControl = this._healthy_consultation._getControl(_g.d.m_consultation._ic_code);
                codeControl.Enabled = false;
                this._healthy_consultation._search(false);
                this._healthy_consultation._isChange = false;
                if (forEdit)
                {
                    this._healthy_consultation._focusFirst();
