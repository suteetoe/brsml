...
{
    public partial class M_information : UserControl
    {
        ...
        public M_information()
        {
            ...
            _myManageData1._dataList._loadViewFormat(_g.g._search_screen_healthy_information, MyLib._myGlobal._userSearchScreenGroup, true);
            _myManageData1._dataList._referFieldAdd(_g.d.m_information._ic_code, 1);            
            ...
            this._healthy_information._saveKeyDown += new MyLib.SaveKeyDownHandler(_healthy_informatio_saveKeyDown);
        ...
        void _healthy_informatio_saveKeyDown(object sender)
        {
            _save_data();
        }
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if ((keyData & Keys.Control) == Keys.Control)
            {
                switch (keyCode)
                {
                    case Keys.Home:
                        {
                            this._healthy_information._focusFirst();
                            return true;
                        }
                }
            }
        ...
        {
            string getEmtry = this._healthy_information._checkEmtryField();
            ...
            else
            {
                ...
                ArrayList __getData = this._healthy_information._createQueryForDatabase();
                ...
                if (result.Length == 0)
                {
                    ...
                    this._healthy_information._isChange = false;
                    if (_myManageData1._mode == 1)
                    {
                    ...
                    this._healthy_information._clear();
                    this._healthy_information._focusFirst();
                }
                else
                {
        ...
        {
            this._healthy_information._clear();
            Control codeControl = this._healthy_information._getControl(_g.d.m_information._ic_code);
        ...
        {
            bool result = true;
            if (this._healthy_information._isChange)
            {
        ...
        bool _myManageData1__loadDataToScreen(object rowData, string whereString, bool forEdit)
        {
            try
            {
                ...
                this._healthy_information._loadData(getData.Tables[0]);
                Control codeControl = this._healthy_information._getControl(_g.d.m_information._ic_code);
                codeControl.Enabled = false;
                this._healthy_information._search(false);
                this._healthy_information._isChange = false;
                if (forEdit)
                {
                    this._healthy_information._focusFirst();
