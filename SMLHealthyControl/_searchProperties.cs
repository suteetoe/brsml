...
namespace SMLHealthyControl
{
    public class _searchProperties
    {
        ...
        public ArrayList _setColumnSearch(string _cName, int _masterUse, string _tName, string screenCode, string where)
        {
            ...
            //    }
            //    else
            //        if ((_cName.Equals(_g.d.ic_trans_detail._unit_code) || _cName.Equals(_g.d.ic_trans_detail._approval_unit) || _cName.Equals(_g.d.ic_inventory_detail._start_purchase_unit)
            ...
            //            __list.Add(MyLib._myGlobal._addUpper(_g.d.erp_doc_format._screen_code, false) + "=\'" + screenCode.ToUpper() + "\'");
            //        }
            //        else if (_cName.Equals(_g.d.ic_trans_detail._branch_code))
            //        {
            //        }
            ...
            //        }
            //        else if (_cName.Equals(_g.d.ic_trans._side_code))
            //        {
            //            __list.Add(_g.g._search_screen_erp_side_list);
            //        }
            //        else if (_cName.Equals(_g.d.ic_trans._department_code))
            //        {
            //            __list.Add(_g.g._search_screen_erp_department_list);
            //        }
            //        else if (_cName.Equals(_g.d.ic_trans._project_code))
            //        {
            //            __list.Add(_g.g._search_screen_erp_project);
            //        }
