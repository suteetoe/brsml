...
{
    public partial class _reportTrans : UserControl
    {
        ...
        public _reportTrans(_reportEnum mode, _g.g._transControlTypeEnum transFlag, string screenName)
        {
            ...
            switch (mode)
            {
                ...
                case _reportEnum.สินค้า_sell_by_sale:
                    __landscape = true;
                    break;
            }
        ...
        void _report__renderValue(SMLReport._generateLevelClass sender, int columnNumber, SMLReport._generateColumnStyle isTotal)
        {
            if (isTotal == SMLReport._generateColumnStyle.Data)
            {
                ...
                if (__lastStatusColumnNumber != -1 && __lastStatusColumnNumber == columnNumber)
                {
                    ...
                    if (__str.Length > 1)
                    {
                        ...
                        switch (this._mode)
                        {
                            ...
                            case _reportEnum.ซื้อ_รายงานสถานะใบสั่งซื้อ:
                                {
                                    int __used_sattus_2 = Int32.Parse(__str[7]);
                                    ...
                                    //if (__usedStatus == 1) __message = MyLib._myGlobal._resource("รับบางส่วน");
                                    if (__used_sattus_2 == 1) __message = MyLib._myGlobal._resource("รับบางส่วน");
                                    if (__docSuccess == 1) __message = MyLib._myGlobal._resource("รับสมบูรณ์");
                                    break;
                                }
                            case _reportEnum.ซื้อ_ใบเสนอซื้อ:
                            case _reportEnum.ซื้อ_ใบเสนอซื้อ_สถานะ:
                ...
                //
                int __discountDetailColumnNumber = sender._findColumnName(_g.d.ic_trans_detail._table + "." + _g.d.ic_trans_detail._discount);
                if (this._mode == _reportEnum.ขาย_ขายสินค้าและบริการ && __discountDetailColumnNumber != -1 && __discountDetailColumnNumber == columnNumber)
                {
                    if (sender._columnList[columnNumber]._dataStr.IndexOf("%") == -1)
                    {
        ...
        private void _reportInitRootColumn(List<SMLReport._generateColumnListClass> columnList)
        {
            ...
            switch (this._mode)
            {
                ...
                case _reportEnum.เงินสดย่อย_รับคืน_ยกเลิก:
                    ...
                    if (this._mode == _reportEnum.สินค้า_รายงานโอนสินค้าและวัตถุดิบ_ยกเลิก)
                    {
                        columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._remark, null, 20, SMLReport._report._cellType.String, 0, __fontStyle));
                    }
                    break;
                case _reportEnum.ขาย_รับเงินล่วงหน้า_ยกเลิก:
                case _reportEnum.ขาย_รับเงินล่วงหน้า_คืน_ยกเลิก:
                ...
                case _reportEnum.สินค้า_รายงานรับสินค้าสำเร็จรูป:
                    ...
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._cust_name, _g.d.ic_trans._table + "." + _g.d.ic_trans._ap_name, 25, SMLReport._report._cellType.String, 0, __fontStyle));

                    if (_g.g._companyProfile._disable_item_cost == false)
                    {
                        columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._total_amount, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_amount_decimal, __fontStyle));
                    }
                    break;
                ...
                case _reportEnum.ขาย_รับคืนสินค้า:
                    {
                        ...
                        {
                            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._total_service_charge, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_amount_decimal, __fontStyle));
                        }
                ...
                case _reportEnum.ขาย_ขายสินค้าและบริการ_ลดหนี้_เพิ่มหนี้:
                    ...
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._doc_no, null, 10, SMLReport._report._cellType.String, 0, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._doc_time, null, 5, SMLReport._report._cellType.String, 0, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._trans_flag, null, 10, SMLReport._report._cellType.String, 0, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._doc_ref_date, null, 8, SMLReport._report._cellType.DateTime, 0, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._doc_ref, null, 8, SMLReport._report._cellType.String, 0, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._cust_code, _g.d.ic_trans._table + "." + _g.d.ic_trans._ar_code, 8, SMLReport._report._cellType.String, 0, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._cust_name, _g.d.ic_trans._table + "." + _g.d.ic_trans._ar_name, 15, SMLReport._report._cellType.String, 0, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._total_value, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_amount_decimal, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._total_discount, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_amount_decimal, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._total_after_discount, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_amount_decimal, __fontStyle));
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._total_except_vat, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_amount_decimal, __fontStyle));
                ...
                case _reportEnum.ซื้อ_ซื้อสินค้าและบริการ:
                    {
                        ...
                        if (this._mode == _reportEnum.ซื้อ_พาเชียล_รับสินค้า)
                        {
                            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._tax_doc_date, null, 8, SMLReport._report._cellType.DateTime, 0, __fontStyle));
                            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._tax_doc_no, null, 10, SMLReport._report._cellType.String, 0, __fontStyle));
                        }
                        else
                        {
                            columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans._table + "." + _g.d.ic_trans._doc_ref_date, null, 8, SMLReport._report._cellType.DateTime, 0, __fontStyle));
        ...
        private void _reportInitColumnValue(List<SMLReport._generateColumnListClass> columnList)
        {
            switch (this._mode)
            {
                ...
                case _reportEnum.ซื้อ_พาเชียล_ลดหนี้:
                    ...
                    {
                        columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans_detail._table + "." + _g.d.ic_trans_detail._discount_amount, null, 8, SMLReport._report._cellType.String, _g.g._companyProfile._item_amount_decimal, FontStyle.Regular));
                    }
                    columnList.Add(new SMLReport._generateColumnListClass(_g.d.ic_trans_detail._table + "." + _g.d.ic_trans_detail._sum_amount, null, 10, SMLReport._report._cellType.Number, _g.g._companyProfile._item_amount_decimal, FontStyle.Regular));
                ...
                try
                {
                    ...
                    switch (this._mode)
                    {
                        ...
                        case _reportEnum.ขาย_เสนอราคา_สถานะ:
                            ...
                            __extraAs.Append("(select name_1 from ar_customer where ar_customer.code=cust_code) ||\'(\'||cust_code||\')\' as \"ic_trans.ar_name\",");
                            ...
                            //
                            __extraField.Append("cust_code,department_code,doc_group,user_request,approve_code,inquiry_type,user_approve,");
                        ...
                        case _reportEnum.ขาย_สั่งจองและสั่งซื้อสินค้า_อนุมัติ:
                            ...
                            //
                            __extraField.Append("cust_code,department_code,doc_group,user_request,approve_code,inquiry_type,user_approve,total_except_vat,total_vat_value,");
                        ...
                        case _reportEnum.ขาย_รับเงินมัดจำ_รายงานยอดคงเหลือ:
                            {
                                __extraAs.Append("cust_code as \"ic_trans.cust_code\",");
                                __extraAs.Append("cust_name as \"ic_trans.cust_name\",");
                                __extraAs.Append("case when _def_last_status = 1 then 0 else deposit_buy2 end as \"ic_trans.deposit_buy2\",");
                                __extraAs.Append("case when _def_last_status = 1 then 0 else sum_used end as \"ic_trans.sum_used\",");
                                __extraAs.Append("case when _def_last_status = 1 then 0 else total_amount-(deposit_buy2+sum_used) end as \"ic_trans.balance_amount\",");
                                ...
                                String __returnFlag = _g.g._transFlagGlobal._transFlag(_g.g._transControlTypeEnum.ขาย_เงินมัดจำ_คืน) + "," +
                                ...
                                __queryPay.Append("coalesce((select sum(total_amount) from ic_trans as x1 where x1.last_status=0 and x1.doc_ref=ic_trans.doc_no and x1.trans_flag in (" + __returnFlag + ")),0) as " + _g.d.ic_trans._deposit_buy2 + ",");
                        ...
                        case _reportEnum.ซื้อ_รายงานตัดเงินจ่ายล่วงหน้า:
                            {
                                ...
                                String __returnFlag = _g.g._transFlagGlobal._transFlag(_g.g._transControlTypeEnum.ซื้อ_จ่ายเงินมัดจำ_รับคืน) + "," +
                                     _g.g._transFlagGlobal._transFlag(_g.g._transControlTypeEnum.ซื้อ_จ่ายเงินล่วงหน้า_รับคืน);

                                StringBuilder __queryPay = new StringBuilder();
                                __queryPay.Append("coalesce((select sum(total_amount) from ic_trans as x1 where x1.last_status=0 and x1.doc_ref=ic_trans.doc_no and x1.trans_flag in (" + __returnFlag + ")),0) as " + _g.d.ic_trans._deposit_sell2 + ",");
                                __queryPay.Append("coalesce((select sum(amount) from cb_trans_detail as x2 where x2.last_status=0 and x2.trans_number=ic_trans.doc_no),0) as " + _g.d.ic_trans._sum_used + ",");
                                //
                                __extraField.Append(__queryPay.ToString());
                                __getWhereMain = this._form_condition._grid._createWhere(_g.d.ic_trans._table + "." + _g.d.ic_trans._cust_code);
                        ...
                        case _reportEnum.ซื้อ_ส่งคืนสินค้าลดหนี้ราคาผิด_ยกเลิก:
                            ...
                            if (MyLib._myGlobal._isVersionEnum == MyLib._myGlobal._versionType.SMLTomYumGoong)
                            {
                                __extraAs.Append(_g.d.ic_trans._total_service_charge + " as \"" + _g.d.ic_trans._table + "." + _g.d.ic_trans._total_service_charge + "\",");
                                __extraField.Append(_g.d.ic_trans._total_service_charge + ",");
                            }

                            if (this._mode == _reportEnum.ซื้อ_พาเชียล_รับสินค้า)
                            {
                                __extraAs.Append("tax_doc_no as \"ic_trans.tax_doc_no\",");
                                __extraAs.Append("tax_doc_date as \"ic_trans.tax_doc_date\",");
                                __extraField.Append("tax_doc_no, tax_doc_date,");
                        ...
                        case _reportEnum.ขาย_ขายสินค้าและบริการ_ลดหนี้_เพิ่มหนี้:
                            ...
                            __extraAs.Append("cust_code as \"ic_trans.cust_code\",");
                            __extraAs.Append("cust_name as \"ic_trans.cust_name\",");
                            __extraAs.Append("(case when (trans_flag = 48) then -1 else 1 end ) * total_before_vat as \"ic_trans.total_before_vat\",");
                            __extraAs.Append("trans_flag as \"ic_trans.trans_flag\",");

                            __extraAs.Append("(case when (trans_flag = 48) then -1 else 1 end ) * total_value as \"ic_trans.total_value\",");
                            __extraAs.Append("(case when (trans_flag = 48) then -1 else 1 end ) * total_discount as \"ic_trans.total_discount\",");
                            __extraAs.Append("(case when (trans_flag = 48) then -1 else 1 end ) * total_after_discount as \"ic_trans.total_after_discount\",");
                            __extraAs.Append("(case when (trans_flag = 48) then -1 else 1 end ) * total_vat_value as \"ic_trans.total_vat_value\",");
                            __extraAs.Append("(case when (trans_flag = 48) then -1 else 1 end ) * total_except_vat as \"ic_trans.total_except_vat\",");

                            __extraField.Append("trans_flag,");
                            __extraField.Append("cust_code,(select name_1 from ar_customer where ic_trans.cust_code=ar_customer.code) as cust_name,");
                            __extraField.Append("total_value,total_discount,total_value - total_discount as total_after_discount,total_vat_value,total_except_vat,");
                            __getWhereMain = this._form_condition._grid._createWhere(_g.d.ic_trans._table + "." + _g.d.ic_trans._cust_code);
                            __getWhere = this._form_condition._grid._createWhere(_g.d.ic_trans_detail._table + "." + _g.d.ic_trans_detail._cust_code);
                        ...
                        case _reportEnum.สินค้า_รายงานรับสินค้าสำเร็จรูป:
                            ...
                            // extrawhere ap_code
                            string __from_ap = this._form_condition._screen._getDataStr(_g.d.resource_report._from_ap);
                            string __to_ap = this._form_condition._screen._getDataStr(_g.d.resource_report._to_ap);

                            if (__from_ap.Length > 0 && __to_ap.Length > 0)
                            {
                                __where = __where + " and cust_code between \'" + __from_ap + "\' and \'" + __to_ap + "\'";
                            }
                    ...
                    if (this._mode == _reportEnum.ขาย_ขายสินค้าและบริการ)
                    {
                        __where = __where + " and ( coalesce(doc_ref, '') = '' or is_pos = 0 ) ";
                    }
                    else if (this._mode == _reportEnum.ขาย_ขายสินค้าและบริการ_รายงานการออกใบกำกับภาษีอย่างเต็ม)
                    {
                        __where = __where + " and coalesce(doc_ref, '') <> \'\' and is_pos = 1";
                    }

                    if (this._mode == _reportEnum.ขาย_ขายสินค้าและบริการ)
                    {
                        string __get_pos_only = this._form_condition._screen._getDataStr(_g.d.resource_report._show_pos_only);
                        string __category_sale = this._form_condition._screen._getDataStr(_g.d.resource_report._category_sale);
                        if (__get_pos_only == "1")
                        {
                            __where = __where + " and is_pos = 1";
                        }
                        else if (__get_pos_only == "2")
                        {
                            __where = __where + " and coalesce(is_pos, 0) = 0 ";
                        }

                        if (__category_sale == "1")
                        {
                            __where = __where + " and " + _g.d.ic_trans._inquiry_type + " in (0,2) ";
                        }
                        else if (__category_sale == "2")
                        {
                            __where = __where + " and " + _g.d.ic_trans._inquiry_type + " in (1,3) ";
                        }
                    ...
                    if (this._mode == _reportEnum.สินค้า_รายงานโอนสินค้าและวัตถุดิบ_ยกเลิก)
                    {
                        __query.Append("remark as \"ic_trans.remark\",");
                    ...
                    __query.Append("cast(last_status as varchar)||','||cast(used_status as varchar)||','||cast(doc_success as varchar)||','||cast(not_approve_1 as varchar)||','||cast(on_hold as varchar)||','||cast(approve_status as varchar)||','||cast(expire_status  as varchar)||','||cast(used_status_2  as varchar) as last_status");
                    ...
                    switch (this._mode)
                    {
                        ...
                        case _reportEnum.ขาย_สั่งจองและสั่งซื้อสินค้า_อนุมัติ:
                            ...
                            __extraDetailField.Append("discount,  coalesce(due_date, (select send_date from ic_trans where ic_trans.doc_no = ic_trans_detail.doc_no and ic_trans.trans_flag = ic_trans_detail.trans_flag )) as due_date,");
                            __priceField = "price";
                        ...
                        case _reportEnum.ซื้อ_ส่งคืนสินค้าลดหนี้ราคาผิด_ยกเลิก:
                            ...
                            __sumAmountField = "sum_amount";
                            __sumAmountTransField = "sum_amount";
                            __extraDetailAs.Append("discount as \"ic_trans_detail.discount\", discount_amount as \"ic_trans_detail.discount_amount\" ,");
                            __extraDetailField.Append("discount,discount_amount,");
                            break;
                        case _reportEnum.ซื้อ_ใบเสนอซื้อ_สถานะ:
                        case _reportEnum.ซื้อ_ใบเสนอซื้อ:
                        case _reportEnum.ซื้อ_ใบเสนอซื้อ_ยกเลิก:
