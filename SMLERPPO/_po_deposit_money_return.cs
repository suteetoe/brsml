...
namespace SMLERPPO
{
    public partial class _po_deposit_money_return : UserControl
    {
        public _po_deposit_money_return(string screenName)
        {
            InitializeComponent();
            this._po_so_deposit_control1._screen_code = "PCR";
