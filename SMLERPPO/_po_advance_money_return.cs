...
namespace SMLERPPO
{
    public partial class _po_advance_money_return : UserControl
    {
        public _po_advance_money_return(string screenName)
        {
            InitializeComponent();
            this._po_so_deposit_control1._screen_code = "PDR";
        ...
        void _buttonPrint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SMLInventoryControl._formSaleOrderPreview __showPrintDialog = new SMLInventoryControl._formSaleOrderPreview(SMLInventoryControl._gForm._formEnum.ซื้อ_คืนเงินมัดจำหรือเงินล่วงหน้า.ToString(), __getDocNo, __getDocDate, __getArCode);
