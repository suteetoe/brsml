...
namespace Crom.Controls.Docking
{
   ...
   public class DockContainer : UserControl
   {
      ...
      public DockContainer()
      {
         ...
         _docker.FormActive += OnFormActived;
      }

      public Form _getActiveForm
      {
          get
          {
              return _docker.SelectedForm;
          }
      }
      ...
      /// <summary>
      /// Occurs after switch active form;
      /// </summary>
      public event EventHandler<FormEventArgs> FormActive;
      ...
      private void OnFormActived(object sender, FormEventArgs e)
      {
          EventHandler<FormEventArgs> handler = FormActive;
          if (handler != null)
          {
              handler(this, e);
          }
